...
- [Machine Learning Frameworks](#machine-learning-frameworks) _59 projects_
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.4K · 🔀 88K · 📦 280K · 📋 38K - 5% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/tensorflow/tensorflow
	```
- [PyPi](https://pypi.org/project/tensorflow) (📥 15M / month · 📦 15K · ⏱️ 16.11.2022):
	```
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">PyTorch</a></b> (🥇51 ·  ⭐ 68K · 📈) - Tensors and Dynamic neural networks in Python with strong GPU.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 4.1K · 🔀 18K · 📥 17K · 📋 35K - 34% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/torch) (📥 11M / month · 📦 9.4K · ⏱️ 05.08.2022):
	```
	pip install torch
	```
- [Conda](https://anaconda.org/pytorch/pytorch) (📥 17M · ⏱️ 05.05.2023):
	```
	conda install -c pytorch pytorch
	```
</details>
<details><summary><b><a href="https://github.com/apache/spark">PySpark</a></b> (🥇45 ·  ⭐ 36K · 📈) - Apache Spark Python API. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1N" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/apache/spark) (👨‍💻 2.9K · 🔀 27K · ⏱️ 08.06.2023):

	```
	git clone https://github.com/apache/spark
	```
- [PyPi](https://pypi.org/project/pyspark) (📥 25M / month · 📦 1K · ⏱️ 28.11.2022):
	```
	pip install pyspark
	```
...
- [GitHub](https://github.com/PaddlePaddle/Paddle) (👨‍💻 1K · 🔀 5.2K · 📥 15K · 📦 250 · 📋 18K - 11% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/PaddlePaddle/Paddle
	```
- [PyPi](https://pypi.org/project/paddlepaddle) (📥 130K / month · 📦 69 · ⏱️ 17.02.2023):
	```
...
- [GitHub](https://github.com/jina-ai/jina) (👨‍💻 170 · 🔀 2.1K · 📦 630 · 📋 1.9K - 2% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/jina-ai/jina
	```
- [PyPi](https://pypi.org/project/jina) (📥 380K / month · 📦 12 · ⏱️ 06.07.2022):
	```
	pip install jina
	```
...
<details><summary><b><a href="https://github.com/Theano/Theano">Theano</a></b> (🥈37 ·  ⭐ 9.7K) - Theano was a Python library that allows you to define, optimize, and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Theano/Theano) (👨‍💻 390 · 🔀 2.5K · 📦 14K · 📋 2.8K - 24% open · ⏱️ 20.12.2022):
...
<details><summary><b><a href="https://github.com/VowpalWabbit/vowpal_wabbit">Vowpal Wabbit</a></b> (🥈37 ·  ⭐ 8.2K) - Vowpal Wabbit is a machine learning system which pushes the.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/VowpalWabbit/vowpal_wabbit) (👨‍💻 330 · 🔀 2K · 📋 1.2K - 10% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/VowpalWabbit/vowpal_wabbit
	```
- [PyPi](https://pypi.org/project/vowpalwabbit) (📥 90K / month · 📦 32 · ⏱️ 09.11.2022):
	```
...
<details><summary><b><a href="https://github.com/apache/flink">PyFlink</a></b> (🥈36 ·  ⭐ 21K · 📈) - Apache Flink Python API. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/apache/flink) (👨‍💻 1.7K · 🔀 12K · ⏱️ 08.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/apache-flink) (📥 54K / month · 📦 22 · ⏱️ 27.09.2022):
	```
	pip install apache-flink
	```
</details>
<details><summary><b><a href="https://github.com/catboost/catboost">Catboost</a></b> (🥈36 ·  ⭐ 7.2K · 📉) - A fast, scalable, high performance Gradient Boosting on.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/google/flax) (👨‍💻 190 · 🔀 500 · 📥 46 · 📦 3.4K · 📋 760 - 19% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/google/flax
	```
- [PyPi](https://pypi.org/project/flax) (📥 650K / month · 📦 130 · ⏱️ 21.06.2022):
	```
	pip install flax
	```
...
- [GitHub](https://github.com/arogozhnikov/einops) (👨‍💻 23 · 🔀 300 · 📦 12K · 📋 150 - 24% open · ⏱️ 15.05.2023):

	```
	git clone https://github.com/arogozhnikov/einops
	```
- [PyPi](https://pypi.org/project/einops) (📥 3.8M / month · 📦 480 · ⏱️ 09.11.2022):
	```
	pip install einops
	```
...
<details><summary><b><a href="https://github.com/unifyai/ivy">ivy</a></b> (🥈33 ·  ⭐ 11K) - Unified AI. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/unifyai/ivy) (👨‍💻 1K · 🔀 4.1K · 📋 9K - 20% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/unifyai/ivy
	```
- [PyPi](https://pypi.org/project/ivy-core) (📥 300 / month · 📦 6 · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/chainer/chainer) (👨‍💻 320 · 🔀 1.4K · 📦 3K · 📋 2K - 0% open · ⏱️ 17.10.2022):
...
- [GitHub](https://github.com/deepmind/sonnet) (👨‍💻 56 · 🔀 1.4K · 📦 1.1K · 📋 190 - 17% open · ⏱️ 23.02.2023):
...
- [GitHub](https://github.com/ludwig-ai/ludwig) (👨‍💻 140 · 🔀 1K · 📦 170 · 📋 970 - 27% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/ludwig-ai/ludwig
	```
- [PyPi](https://pypi.org/project/ludwig) (📥 2.4K / month · 📦 9 · ⏱️ 28.10.2022):
	```
	pip install ludwig
	```
</details>
...
- [GitHub](https://github.com/deepmind/dm-haiku) (👨‍💻 75 · 🔀 210 · 📦 1.3K · 📋 260 - 38% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/deepmind/dm-haiku
	```
- [PyPi](https://pypi.org/project/dm-haiku) (📥 120K / month · 📦 66 · ⏱️ 04.07.2022):
	```
...
- [GitHub](https://github.com/amaiya/ktrain) (👨‍💻 16 · 🔀 260 · 📦 430 · 📋 460 - 0% open · ⏱️ 05.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/ktrain) (📥 21K / month · 📦 3 · ⏱️ 03.02.2023):
	```
	pip install ktrain
	```
</details>
...
<details><summary><b><a href="https://github.com/geomstats/geomstats">Geomstats</a></b> (🥉30 ·  ⭐ 950) - Computations and statistics on manifolds with geometric structures. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/geomstats/geomstats) (👨‍💻 81 · 🔀 210 · 📦 68 · 📋 540 - 42% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/geomstats/geomstats
	```
- [PyPi](https://pypi.org/project/geomstats) (📥 1.7K / month · 📦 3 · ⏱️ 28.08.2018):
	```
	pip install geomstats
	```
- [Conda](https://anaconda.org/conda-forge/geomstats) (📥 1.3K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/towhee-io/towhee) (👨‍💻 30 · 🔀 200 · 📥 1.1K · 📋 610 - 0% open · ⏱️ 08.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/towhee) (📥 2.1K / month · ⏱️ 07.07.2022):
	```
	pip install towhee
	```
</details>
...
<details><summary><b><a href="https://github.com/pyRiemann/pyRiemann">pyRiemann</a></b> (🥉26 ·  ⭐ 500) - Machine learning for multivariate data analysis through the.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pyRiemann/pyRiemann) (👨‍💻 25 · 🔀 150 · 📦 250 · 📋 95 - 7% open · ⏱️ 28.05.2023):

	```
	git clone https://github.com/pyRiemann/pyRiemann
	```
- [PyPi](https://pypi.org/project/pyriemann) (📥 45K / month · 📦 16 · ⏱️ 17.07.2022):
	```
	pip install pyriemann
	```
- [Conda](https://anaconda.org/conda-forge/pyriemann) (📥 3K · ⏱️ 15.02.2023):
	```
...
- [GitHub](https://github.com/google/objax) (👨‍💻 25 · 🔀 74 · 📦 36 · 📋 110 - 45% open · ⏱️ 01.05.2023):

	```
	git clone https://github.com/google/objax
	```
- [PyPi](https://pypi.org/project/objax) (📥 730 / month · 📦 5 · ⏱️ 31.01.2022):
	```
	pip install objax
	```
</details>
...
- [GitHub](https://github.com/plotly/dash) (👨‍💻 140 · 🔀 1.9K · 📦 48K · 📋 1.6K - 47% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/plotly/dash
	```
- [PyPi](https://pypi.org/project/dash) (📥 1.5M / month · 📦 1.3K · ⏱️ 13.06.2022):
	```
	pip install dash
	```
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 100 · 🔀 200 · 📦 5.2K · 📋 560 - 13% open · ⏱️ 10.05.2023):

	```
	git clone https://github.com/has2k1/plotnine
	```
- [PyPi](https://pypi.org/project/plotnine) (📥 970K / month · 📦 240 · ⏱️ 25.04.2017):
	```
...
- [GitHub](https://github.com/voxel51/fiftyone) (👨‍💻 83 · 🔀 350 · 📦 320 · 📋 1.3K - 37% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/voxel51/fiftyone
	```
- [PyPi](https://pypi.org/project/fiftyone) (📥 65K / month · 📦 7 · ⏱️ 24.06.2022):
	```
	pip install fiftyone
	```
</details>
<details><summary><b><a href="https://github.com/vispy/vispy">VisPy</a></b> (🥈35 ·  ⭐ 3.1K) - High-performance interactive 2D/3D data visualization library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/vispy/vispy) (👨‍💻 190 · 🔀 610 · 📦 1.2K · 📋 1.4K - 22% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 67K / month · 📦 120 · ⏱️ 04.07.2022):
	```
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 390K · ⏱️ 13.05.2023):
	...
	```
- [npm](https://www.npmjs.com/package/vispy) (📥 5 / month · 📦 1 · ⏱️ 15.03.2020):
	```
	npm install vispy
	```
</details>
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 120 · 🔀 340 · 📥 720 · 📦 1.9K · 📋 1.2K - 29% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/pyvista/pyvista
	```
- [PyPi](https://pypi.org/project/pyvista) (📥 96K / month · 📦 180 · ⏱️ 30.06.2022):
	```
	pip install pyvista
	```
...
- [GitHub](https://github.com/xflr6/graphviz) (👨‍💻 19 · 🔀 200 · 📦 49K · 📋 160 - 5% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/xflr6/graphviz
	```
- [PyPi](https://pypi.org/project/graphviz) (📥 8.1M / month · 📦 3.2K · ⏱️ 14.10.2017):
	```
...
<details><summary><b><a href="https://github.com/PAIR-code/facets">Facets Overview</a></b> (🥈30 ·  ⭐ 7.1K) - Visualizations for machine learning datasets. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PAIR-code/facets) (👨‍💻 31 · 🔀 910 · 📦 180 · 📋 160 - 50% open · ⏱️ 24.05.2023):

	```
	git clone https://github.com/pair-code/facets
	```
- [PyPi](https://pypi.org/project/facets-overview) (📥 140K / month · 📦 9 · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/man-group/dtale) (👨‍💻 29 · 🔀 340 · 📦 740 · 📋 510 - 8% open · ⏱️ 16.05.2023):

	```
	git clone https://github.com/man-group/dtale
	```
- [PyPi](https://pypi.org/project/dtale) (📥 160K / month · 📦 16 · ⏱️ 17.06.2022):
	```
	pip install dtale
	```
...
- [GitHub](https://github.com/mpld3/mpld3) (👨‍💻 51 · 🔀 350 · 📦 4.7K · 📋 360 - 59% open · ⏱️ 10.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/mpld3) (📥 260K / month):
	```
	pip install mpld3
	```
- [Conda](https://anaconda.org/conda-forge/mpld3) (📥 180K · ⏱️ 10.12.2022):
	...
	```
- [npm](https://www.npmjs.com/package/mpld3) (📥 880 / month):
	```
	npm install mpld3
	```
</details>
<details><summary><b><a href="https://github.com/jupyter-widgets/pythreejs">pythreejs</a></b> (🥉28 ·  ⭐ 870) - A Jupyter - Three.js bridge. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/tensorflow/data-validation) (👨‍💻 25 · 🔀 150 · 📥 430 · 📦 690 · 📋 170 - 21% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/tensorflow/data-validation
	```
- [PyPi](https://pypi.org/project/tensorflow-data-validation) (📥 390K / month · 📦 29 · ⏱️ 29.06.2022):
	```
...
- [GitHub](https://github.com/JetBrains/lets-plot) (👨‍💻 19 · 🔀 45 · 📥 480 · 📦 33 · 📋 370 - 25% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/JetBrains/lets-plot
	```
- [PyPi](https://pypi.org/project/lets-plot) (📥 12K / month · 📦 1 · ⏱️ 15.12.2022):
	```
	pip install lets-plot
	```
</details>
<details><summary><b><a href="https://github.com/ydataai/pandas-profiling">pandas-profiling</a></b> (🥉26 ·  ⭐ 11K) - Deprecated pandas-profiling package, use ydata-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub]() (👨‍💻 110 · 🔀 1.5K · 📦 590):
	...
	```
- [PyPi](https://pypi.org/project/pandas-profiling) (📥 940K / month · 📦 190 · ⏱️ 27.09.2021):
	```
...
<details><summary><b><a href="https://github.com/predict-idlab/plotly-resampler">Plotly-Resampler</a></b> (🥉26 ·  ⭐ 740) - Visualize large time series data with plotly.py. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/predict-idlab/plotly-resampler) (👨‍💻 10 · 🔀 49 · 📦 330 · 📋 120 - 30% open · ⏱️ 30.05.2023):

	```
	git clone https://github.com/predict-idlab/plotly-resampler
	```
- [PyPi](https://pypi.org/project/plotly-resampler) (📥 310K / month):
	```
	pip install plotly-resampler
	```
- [Conda](https://anaconda.org/conda-forge/plotly-resampler) (📥 20K · ⏱️ 10.04.2023):
	```
...
<details><summary><b><a href="https://github.com/DmitryUlyanov/Multicore-TSNE">Multicore-TSNE</a></b> (🥉25 ·  ⭐ 1.8K) - Parallel t-SNE implementation with Python and Torch.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/DmitryUlyanov/Multicore-TSNE) (👨‍💻 17 · 🔀 200 · 📦 380 · 📋 59 - 64% open · ⏱️ 26.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/MulticoreTSNE) (📥 19K / month · 📦 22 · ⏱️ 09.01.2019):
	```
...
<details><summary><b><a href="https://github.com/fbdesignpro/sweetviz">Sweetviz</a></b> (🥉24 ·  ⭐ 2.4K · 💤) - Visualize and compare datasets, target values and associations, with.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/fbdesignpro/sweetviz) (👨‍💻 6 · 🔀 240 · 📋 120 - 38% open · ⏱️ 08.06.2022):

	```
	git clone https://github.com/fbdesignpro/sweetviz
	```
- [PyPi](https://pypi.org/project/sweetviz) (📥 69K / month · 📦 10 · ⏱️ 14.06.2022):
	```
...
- [GitHub](https://github.com/PatrikHlobil/Pandas-Bokeh) (👨‍💻 15 · 🔀 110 · 📦 470 · 📋 100 - 32% open · ⏱️ 06.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/pandas-bokeh) (📥 27K / month · 📦 12 · ⏱️ 11.04.2021):
	```
...
- [GitHub](https://github.com/ing-bank/popmon) (👨‍💻 17 · 🔀 34 · 📥 90 · 📦 20 · 📋 52 - 28% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/ing-bank/popmon
	```
- [PyPi](https://pypi.org/project/popmon) (📥 10K / month · 📦 2 · ⏱️ 08.07.2022):
	```
	pip install popmon
	```
</details>
...
- [GitHub](https://github.com/marcharper/python-ternary) (👨‍💻 27 · 🔀 140 · 📥 21 · 📦 140 · 📋 140 - 27% open · ⏱️ 31.12.2022):

	```
	git clone https://github.com/marcharper/python-ternary
	```
- [PyPi](https://pypi.org/project/python-ternary) (📥 57K / month · 📦 22 · ⏱️ 17.02.2021):
	```
...
<details><summary><b><a href="https://github.com/SauceCat/PDPbox">PDPbox</a></b> (🥉21 ·  ⭐ 750) - python partial dependence plot toolbox. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/SauceCat/PDPbox) (👨‍💻 7 · 🔀 120 · 📋 65 - 40% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/SauceCat/PDPbox
	```
- [PyPi](https://pypi.org/project/pdpbox) (📥 24K / month · 📦 26 · ⏱️ 14.03.2021):
	```
	pip install pdpbox
	```
...
- <b><a href="https://github.com/adamerose/PandasGUI">PandasGUI</a></b> (🥉24 ·  ⭐ 2.9K · 💀) - A GUI for Pandas DataFrames. <code><a href="https://tldrlegal.com/search?q=MIT-0">❗️MIT-0</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/hex-inc/vegafusion">vegafusion</a></b> (🥉22 ·  ⭐ 240) - Serverside scaling for Vega and Altair visualizations. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/Zsailer/nx_altair">nx-altair</a></b> (🥉16 ·  ⭐ 210 · 💀) - Draw interactive NetworkX graphs with Altair. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/explosion/spaCy) (👨‍💻 730 · 🔀 4.1K · 📦 62K · 📋 5.5K - 2% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/explosion/spaCy
	```
- [PyPi](https://pypi.org/project/spacy) (📥 5.4M / month · 📦 2.7K · ⏱️ 05.04.2022):
	```
	pip install spacy
	```
...
- [GitHub](https://github.com/RasaHQ/rasa) (👨‍💻 580 · 🔀 4.4K · 📦 3.4K · 📋 6.8K - 1% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/RasaHQ/rasa
	```
- [PyPi](https://pypi.org/project/rasa) (📥 130K / month · 📦 65 · ⏱️ 06.07.2022):
	```
	pip install rasa
	```
</details>
...
- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 180 · 🔀 1.2K · 📥 22 · 📦 730 · 📋 2.3K - 15% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/deepset-ai/haystack
	```
- [PyPi](https://pypi.org/project/haystack) (📥 2.8K / month · 📦 85 · ⏱️ 03.07.2017):
	```
...
- [GitHub](https://github.com/OpenNMT/OpenNMT-py) (👨‍💻 190 · 🔀 2.2K · 📦 200 · 📋 1.4K - 1% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/OpenNMT/OpenNMT-py
	```
- [PyPi](https://pypi.org/project/OpenNMT-py) (📥 4.1K / month · 📦 9 · ⏱️ 19.12.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/fastText) (👨‍💻 61 · 🔀 4.6K · 📦 4.6K · 📋 1.1K - 46% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/facebookresearch/fastText
	```
- [PyPi](https://pypi.org/project/fasttext) (📥 1M / month · 📦 200 · ⏱️ 28.04.2020):
	```
...
<details><summary><b><a href="https://github.com/huggingface/tokenizers">Tokenizers</a></b> (🥈34 ·  ⭐ 7.1K) - Fast State-of-the-Art Tokenizers optimized for Research and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/tokenizers) (👨‍💻 70 · 🔀 600 · 📥 9 · 📦 62 · 📋 800 - 32% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/huggingface/tokenizers
	```
- [PyPi](https://pypi.org/project/tokenizers) (📥 11M / month · 📦 230 · ⏱️ 13.04.2022):
	```
...
<details><summary><b><a href="https://github.com/RaRe-Technologies/gensim">gensim</a></b> (🥈33 ·  ⭐ 14K · 📉) - Topic Modelling for Humans. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 450 · 🔀 4.4K · 📥 4.4K · 📋 1.8K - 21% open · ⏱️ 25.05.2023):
...
- [GitHub](https://github.com/deeppavlov/DeepPavlov) (👨‍💻 74 · 🔀 1.1K · 📦 350 · 📋 630 - 8% open · ⏱️ 06.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/deeppavlov) (📥 9.3K / month · 📦 6 · ⏱️ 13.07.2018):
	```
...
- [GitHub](https://github.com/argilla-io/argilla) (👨‍💻 51 · 🔀 190 · 📦 660 · 📋 1.2K - 18% open · ⏱️ 08.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/rubrix) (📥 680 / month · 📦 1 · ⏱️ 24.10.2022):
	```
	pip install rubrix
	```
...
- [GitHub](https://github.com/explosion/spacy-transformers) (👨‍💻 21 · 🔀 160 · 📦 1.1K · ⏱️ 22.05.2023):

	```
	git clone https://github.com/explosion/spacy-transformers
	```
- [PyPi](https://pypi.org/project/spacy-transformers) (📥 270K / month · 📦 35 · ⏱️ 05.07.2022):
	```
...
- [GitHub](https://github.com/zjunlp/DeepKE) (👨‍💻 23 · 🔀 500 · 📦 16 · 📋 260 - 1% open · ⏱️ 08.06.2023):
...
- [GitHub](https://github.com/allenai/scispacy) (👨‍💻 29 · 🔀 190 · 📦 710 · 📋 290 - 10% open · ⏱️ 16.05.2023):

	```
	git clone https://github.com/allenai/scispacy
	```
- [PyPi](https://pypi.org/project/scispacy) (📥 47K / month · 📦 30 · ⏱️ 07.09.2022):
	```
...
- [GitHub](https://github.com/dmlc/gluon-nlp) (👨‍💻 84 · 🔀 520 · 📦 1.3K · 📋 560 - 46% open · ⏱️ 25.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/gluonnlp) (📥 97K / month · 📦 22 · ⏱️ 13.08.2020):
	```
	pip install gluonnlp
	```
</details>
<details><summary><b><a href="https://github.com/dwyl/english-words">english-words</a></b> (🥈28 ·  ⭐ 9K · 💤) - A text file containing 479k English words for all your.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/dwyl/english-words) (👨‍💻 30 · 🔀 1.7K · 📋 120 - 72% open · ⏱️ 08.11.2022):

	```
	git clone https://github.com/dwyl/english-words
	```
- [PyPi](https://pypi.org/project/english-words) (📥 390K / month · 📦 8 · ⏱️ 06.01.2023):
	```
...
- [GitHub](https://github.com/Ciphey/Ciphey) (👨‍💻 47 · 🔀 820 · 📋 310 - 17% open · ⏱️ 05.12.2022):

	```
	git clone https://github.com/Ciphey/Ciphey
	```
- [PyPi](https://pypi.org/project/ciphey) (📥 37K / month · ⏱️ 08.07.2020):
	```
	pip install ciphey
	```
...
- [GitHub](https://github.com/qdrant/qdrant) (👨‍💻 51 · 🔀 540 · 📥 160 · 📋 540 - 16% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/thunlp/OpenPrompt) (👨‍💻 20 · 🔀 360 · 📦 55 · 📋 230 - 25% open · ⏱️ 06.05.2023):

	```
	git clone https://github.com/thunlp/OpenPrompt
	```
- [PyPi](https://pypi.org/project/openprompt) (📥 3.1K / month · 📦 2 · ⏱️ 06.07.2022):
	```
...
- [GitHub](https://github.com/explosion/sense2vec) (👨‍💻 19 · 🔀 240 · 📥 54K · 📦 260 · 📋 110 - 18% open · ⏱️ 20.04.2023):

	```
	git clone https://github.com/explosion/sense2vec
	```
- [PyPi](https://pypi.org/project/sense2vec) (📥 5.3K / month · 📦 13 · ⏱️ 19.04.2021):
	```
...
<details><summary><b><a href="https://github.com/bigscience-workshop/promptsource">promptsource</a></b> (🥉25 ·  ⭐ 1.8K) - Toolkit for creating, sharing and using natural language.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/bigscience-workshop/promptsource) (👨‍💻 62 · 🔀 250 · 📦 45 · 📋 190 - 27% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/bigscience-workshop/promptsource
	```
- [PyPi](https://pypi.org/project/promptsource) (📥 3K / month · 📦 1 · ⏱️ 18.04.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 230 · 🔀 820 · 📥 340 · 📋 220 - 66% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/facebookresearch/pytext
	```
- [PyPi](https://pypi.org/project/pytext-nlp) (📥 88 / month · 📦 1 · ⏱️ 08.06.2020):
	```
...
- [GitHub](https://github.com/jbesomi/texthero) (👨‍💻 20 · 🔀 230 · 📥 110 · 📋 140 - 55% open · ⏱️ 28.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/texthero) (📥 13K / month · 📦 6 · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/awslabs/sockeye) (👨‍💻 59 · 🔀 330 · 📥 16 · 📋 300 - 0% open · ⏱️ 02.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/sockeye) (📥 880 / month · 📦 2 · ⏱️ 12.06.2017):
	```
	pip install sockeye
	```
</details>
...
- [GitHub](https://github.com/unitaryai/detoxify) (👨‍💻 9 · 🔀 85 · 📥 230K · 📦 320 · 📋 53 - 56% open · ⏱️ 15.05.2023):

	```
	git clone https://github.com/unitaryai/detoxify
	```
- [PyPi](https://pypi.org/project/detoxify) (📥 12K / month · 📦 10 · ⏱️ 19.12.2022):
	```
...
<details><summary><b><a href="https://github.com/bytedance/lightseq">lightseq</a></b> (🥉21 ·  ⭐ 2.8K) - LightSeq: A High Performance Library for Sequence Processing and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/bytedance/lightseq) (👨‍💻 17 · 🔀 310 · 📥 660 · 📋 270 - 59% open · ⏱️ 10.05.2023):

	```
	git clone https://github.com/bytedance/lightseq
	```
- [PyPi](https://pypi.org/project/lightseq) (📥 3.5K / month · 📦 2 · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/utterworks/fast-bert) (👨‍💻 36 · 🔀 340 · 📋 250 - 62% open · ⏱️ 31.03.2023):

	```
	git clone https://github.com/utterworks/fast-bert
	```
- [PyPi](https://pypi.org/project/fast-bert) (📥 1.9K / month · 📦 2 · ⏱️ 22.09.2022):
	```
...
- [GitHub](https://github.com/IndicoDataSolutions/finetune) (👨‍💻 21 · 🔀 76 · 📦 11 · 📋 140 - 16% open · ⏱️ 18.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/finetune) (📥 83 / month · 📦 2 · ⏱️ 20.12.2021):
	```
	pip install finetune
	```
</details>
<details><summary><b><a href="https://github.com/webis-de/small-text">small-text</a></b> (🥉21 ·  ⭐ 460) - Active Learning for Text Classification in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/webis-de/small-text) (👨‍💻 3 · 🔀 47 · 📦 19 · 📋 30 - 20% open · ⏱️ 27.05.2023):

	```
	git clone https://github.com/webis-de/small-text
	```
- [PyPi](https://pypi.org/project/small-text) (📥 520 / month · ⏱️ 14.06.2022):
	```
	pip install small-text
	```
- [Conda](https://anaconda.org/conda-forge/small-text) (📥 3.1K · ⏱️ 21.02.2023):
	```
...
- [GitHub](https://github.com/EricFillion/happy-transformer) (👨‍💻 14 · 🔀 55 · 📦 170 · 📋 120 - 22% open · ⏱️ 06.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/happytransformer) (📥 4.2K / month · 📦 5 · ⏱️ 06.02.2022):
	```
...
- [GitHub](https://github.com/dsfsi/textaugment) (👨‍💻 7 · 🔀 55 · 📥 57 · 📦 52 · 📋 20 - 35% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/dsfsi/textaugment
	```
- [PyPi](https://pypi.org/project/textaugment) (📥 3.4K / month · 📦 4 · ⏱️ 05.11.2020):
	```
...
- [GitHub](https://github.com/RUCAIBox/TextBox) (👨‍💻 18 · 🔀 110 · 📦 5 · 📋 64 - 4% open · ⏱️ 18.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/textbox) (📥 2 / month · ⏱️ 15.04.2021):
	```
	pip install textbox
	```
</details>
<details><summary><b><a href="https://github.com/unum-cloud/uform">UForm</a></b> (🥉17 ·  ⭐ 360 · 🐣) - Multi-Modal Transformers library for Semantic Search and other.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/unum-cloud/uform) (👨‍💻 8 · 🔀 14 · 📦 4 · ⏱️ 02.05.2023):

	```
	git clone https://github.com/unum-cloud/uform
	```
- [PyPi](https://pypi.org/project/uform) (📥 400 / month):
	```
	pip install uform
	```
</details>
...
- [GitHub](https://github.com/thunlp/OpenNRE) (👨‍💻 12 · 🔀 1K · 📋 360 - 2% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/facebookresearch/vizseq) (👨‍💻 3 · 🔀 55 · 📦 6 · 📋 16 - 43% open · ⏱️ 08.05.2023):

	```
	git clone https://github.com/facebookresearch/vizseq
	```
- [PyPi](https://pypi.org/project/vizseq) (📥 66 / month · ⏱️ 07.08.2020):
	```
	pip install vizseq
	```
</details>
...
- <b><a href="https://github.com/cjhutto/vaderSentiment">vaderSentiment</a></b> (🥈27 ·  ⭐ 4K · 💀) - VADER Sentiment Analysis. VADER (Valence Aware Dictionary and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/undertheseanlp/underthesea">underthesea</a></b> (🥉26 ·  ⭐ 1.2K) - Underthesea - Vietnamese NLP Toolkit. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
- <b><a href="https://github.com/minimaxir/gpt-2-simple">gpt-2-simple</a></b> (🥉22 ·  ⭐ 3.3K · 💀) - Python package to easily retrain OpenAIs GPT-2 text-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/Ki6an/fastT5">fastT5</a></b> (🥉19 ·  ⭐ 470 · 💀) - boost inference speed of T5 models by 5x & reduce the model size.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
- <b><a href="https://github.com/PKSHATechnology-Research/camphr">Camphr</a></b> (🥉19 ·  ⭐ 340 · 💀) - Camphr - NLP libary for creating pipeline components. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>spacy</code>
...
- <b><a href="https://github.com/koursaros-ai/nboost">nboost</a></b> (🥉17 ·  ⭐ 660 · 💀) - NBoost is a scalable, search-api-boosting platform for deploying.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
<details><summary><b><a href="https://github.com/pytorch/vision">torchvision</a></b> (🥇42 ·  ⭐ 14K · 📈) - Datasets, Transforms and Models specific to Computer Vision. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytorch/vision) (👨‍💻 530 · 🔀 6.7K · 📥 26K · 📋 3K - 29% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/pytorch/vision
	```
- [PyPi](https://pypi.org/project/torchvision) (📥 6.9M / month · 📦 4.2K · ⏱️ 24.04.2018):
	```
...
<details><summary><b><a href="https://github.com/huggingface/pytorch-image-models">PyTorch Image Models</a></b> (🥇37 ·  ⭐ 26K) - PyTorch image models, scripts, pretrained weights --.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/huggingface/pytorch-image-models) (👨‍💻 100 · 🔀 4.1K · 📥 4.7M · 📋 740 - 8% open · ⏱️ 02.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/timm) (📥 3M / month · 📦 260 · ⏱️ 12.01.2023):
	```
	pip install timm
	```
...
- [GitHub](https://github.com/Zulko/moviepy) (👨‍💻 160 · 🔀 1.4K · 📦 25K · 📋 1.3K - 24% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/Zulko/moviepy
	```
- [PyPi](https://pypi.org/project/moviepy) (📥 620K / month · 📦 880 · ⏱️ 05.10.2020):
	```
	pip install moviepy
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleSeg) (👨‍💻 110 · 🔀 1.5K · 📦 940 · 📋 1.8K - 14% open · ⏱️ 29.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/paddleseg) (📥 3.3K / month · 📦 3 · ⏱️ 30.11.2022):
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 200 · 📥 16K · 📦 16K · 📋 400 - 5% open · ⏱️ 05.03.2023):

	```
	git clone https://github.com/emcconville/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 690K / month · 📦 710 · ⏱️ 05.01.2023):
	```
	pip install wand
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleDetection) (👨‍💻 140 · 🔀 2.6K · 📦 86 · 📋 4.9K - 21% open · ⏱️ 30.05.2023):

	```
	git clone https://github.com/PaddlePaddle/PaddleDetection
	```
- [PyPi](https://pypi.org/project/paddledet) (📥 730 / month · 📦 1 · ⏱️ 19.09.2022):
	```
	pip install paddledet
	```
</details>
<details><summary><b><a href="https://github.com/serengil/deepface">deepface</a></b> (🥈32 ·  ⭐ 6.5K) - A Lightweight Face Recognition and Facial Attribute Analysis (Age,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/serengil/deepface) (👨‍💻 41 · 🔀 1.3K · 📦 1.5K · 📋 710 - 2% open · ⏱️ 11.05.2023):

	```
	git clone https://github.com/serengil/deepface
	```
- [PyPi](https://pypi.org/project/deepface) (📥 51K / month · 📦 12 · ⏱️ 24.01.2023):
	```
...
- [GitHub](https://github.com/JohannesBuchner/imagehash) (👨‍💻 25 · 🔀 320 · 📦 9.4K · 📋 120 - 7% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/JohannesBuchner/imagehash
	```
- [PyPi](https://pypi.org/project/ImageHash) (📥 1.3M / month · 📦 370 · ⏱️ 28.09.2022):
	```
...
- [GitHub](https://github.com/lucidrains/vit-pytorch) (👨‍💻 17 · 🔀 2.3K · 📦 260 · 📋 230 - 46% open · ⏱️ 20.05.2023):

	```
	git clone https://github.com/lucidrains/vit-pytorch
	```
- [PyPi](https://pypi.org/project/vit-pytorch) (📥 20K / month · 📦 6 · ⏱️ 30.06.2022):
	```
...
<details><summary><b><a href="https://github.com/1adrianb/face-alignment">Face Alignment</a></b> (🥈29 ·  ⭐ 6.3K) - 2D and 3D Face alignment library build using pytorch. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/1adrianb/face-alignment) (👨‍💻 25 · 🔀 1.3K · 📋 300 - 22% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/1adrianb/face-alignment
	```
- [PyPi](https://pypi.org/project/face-alignment) (📥 57K / month · 📦 8 · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/lightly-ai/lightly) (👨‍💻 28 · 🔀 200 · 📦 120 · 📋 420 - 18% open · ⏱️ 08.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/lightly) (📥 7.5K / month · 📦 4 · ⏱️ 05.07.2022):
	```
	pip install lightly
	```
</details>
...
<details><summary><b><a href="https://github.com/mindee/doctr">doctr</a></b> (🥉28 ·  ⭐ 1.9K) - docTR (Document Text Recognition) - a seamless, high-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/mindee/doctr) (👨‍💻 33 · 🔀 250 · 📥 1.4M · 📦 150 · 📋 250 - 20% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/mindee/doctr
	```
- [PyPi](https://pypi.org/project/python-doctr) (📥 7.3K / month · 📦 4 · ⏱️ 22.03.2022):
	```
...
- [GitHub](https://github.com/luispedro/mahotas) (👨‍💻 34 · 🔀 150 · 📦 1.1K · 📋 83 - 24% open · ⏱️ 29.04.2023):

	```
	git clone https://github.com/luispedro/mahotas
	```
- [PyPi](https://pypi.org/project/mahotas) (📥 12K / month · 📦 120 · ⏱️ 28.06.2022):
	```
	pip install mahotas
	```
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥉27 ·  ⭐ 2.8K) - A High-performance cross-platform Video Processing Python framework.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 220 · 📥 820 · 📦 400 · 📋 260 - 1% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 8.5K / month · 📦 10 · ⏱️ 05.07.2022):
	```
	pip install vidgear
	```
</details>
<details><summary><b><a href="https://github.com/CellProfiler/CellProfiler">CellProfiler</a></b> (🥉27 ·  ⭐ 770) - An open-source application for biological image analysis. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/CellProfiler/CellProfiler) (👨‍💻 140 · 🔀 350 · 📥 5.1K · 📦 19 · 📋 3.2K - 8% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/CellProfiler/CellProfiler
	```
- [PyPi](https://pypi.org/project/cellprofiler) (📥 600 / month · 📦 1 · ⏱️ 22.07.2021):
	```
...
- [GitHub](https://github.com/Layout-Parser/layout-parser) (👨‍💻 8 · 🔀 360 · 📦 320 · 📋 130 - 58% open · ⏱️ 06.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/layoutparser) (📥 78K / month · 📦 6 · ⏱️ 06.04.2022):
	```
...
- [GitHub](https://github.com/tryolabs/norfair) (👨‍💻 24 · 🔀 180 · 📥 280 · 📦 120 · 📋 120 - 2% open · ⏱️ 15.05.2023):

	```
	git clone https://github.com/tryolabs/norfair
	```
- [PyPi](https://pypi.org/project/norfair) (📥 12K / month · 📦 3 · ⏱️ 30.05.2022):
	```
	pip install norfair
	```
</details>
...
<details><summary><b><a href="https://github.com/qubvel/segmentation_models">segmentation_models</a></b> (🥉25 ·  ⭐ 4.3K · 💤) - Segmentation models with pretrained backbones. Keras.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/qubvel/segmentation_models) (👨‍💻 14 · 🔀 970 · 📋 510 - 47% open · ⏱️ 29.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/segmentation_models) (📥 26K / month · 📦 28 · ⏱️ 10.01.2020):
	```
...
- [GitHub](https://github.com/facebookresearch/pytorchvideo) (👨‍💻 52 · 🔀 350 · 📋 190 - 46% open · ⏱️ 05.05.2023):

	```
	git clone https://github.com/facebookresearch/pytorchvideo
	```
- [PyPi](https://pypi.org/project/pytorchvideo) (📥 20K / month · 📦 7 · ⏱️ 20.01.2022):
	```
...
- [GitHub](https://github.com/libffcv/ffcv) (👨‍💻 27 · 🔀 150 · 📦 23 · 📋 230 - 32% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/libffcv/ffcv
	```
- [PyPi](https://pypi.org/project/ffcv) (📥 810 / month · 📦 1 · ⏱️ 28.01.2022):
	```
	pip install ffcv
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/ClassyVision">Classy Vision</a></b> (🥉24 ·  ⭐ 1.6K) - An end-to-end PyTorch framework for image and video.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/facebookresearch/ClassyVision) (👨‍💻 77 · 🔀 280 · 📋 120 - 45% open · ⏱️ 23.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/classy_vision) (📥 2.2K / month · 📦 4 · ⏱️ 21.03.2023):
	```
...
<details><summary><b><a href="https://github.com/google-research/kubric">kubric</a></b> (🥉23 ·  ⭐ 1.9K) - A data generation pipeline for creating semi-realistic synthetic.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/google-research/kubric) (👨‍💻 23 · 🔀 170 · 📦 2 · 📋 180 - 29% open · ⏱️ 31.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/kubric-nightly) (📥 14K / month · ⏱️ 06.07.2022):
	```
	pip install kubric-nightly
	```
</details>
<details><summary><b><a href="https://github.com/airctic/icevision">icevision</a></b> (🥉23 ·  ⭐ 820) - An Agnostic Computer Vision Framework - Pluggable to any Training.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/airctic/icevision) (👨‍💻 41 · 🔀 140 · 📋 570 - 10% open · ⏱️ 07.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/icevision) (📥 8.1K / month · 📦 5 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 47 · 📦 530 · 📋 360 - 39% open · ⏱️ 11.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 27K / month · 📦 44 · ⏱️ 12.06.2022):
	```
	pip install pyvips
	```
...
- [GitHub](https://github.com/facebookresearch/vissl) (👨‍💻 35 · 🔀 310 · 📦 18 · 📋 180 - 42% open · ⏱️ 03.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/vissl) (📥 460 / month · 📦 1 · ⏱️ 02.11.2021):
	```
	pip install vissl
	```
</details>
...
<details><summary><b><a href="https://github.com/rhsimplex/image-match">image-match</a></b> (🥉20 ·  ⭐ 2.9K) - Quickly search over billions of images. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/rhsimplex/image-match) (👨‍💻 19 · 🔀 400 · 📋 110 - 57% open · ⏱️ 06.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/image_match) (📥 970 / month · 📦 4 · ⏱️ 13.02.2017):
	```
...
- [GitHub](https://github.com/facebookresearch/detr) (👨‍💻 26 · 🔀 2K · 📋 500 - 43% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/google-research/scenic) (👨‍💻 64 · 🔀 310 · 📋 220 - 68% open · ⏱️ 08.06.2023):
...
- <b><a href="https://github.com/hhatto/nude.py">nude.py</a></b> (🥉21 ·  ⭐ 910 · 💀) - Nudity detection with Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/qanastek/HugsVision">HugsVision</a></b> (🥉16 ·  ⭐ 180) - HugsVision is a easy to use huggingface wrapper for state-of-the-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>huggingface</code>
- <b><a href="https://github.com/nicolas-chaulet/torch-points3d">Torch Points 3D</a></b> (🥉16 ·  ⭐ 140 · 💀) - Pytorch framework for doing deep learning on point.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/snap-stanford/ogb) (👨‍💻 31 · 🔀 380 · 📦 880 · 📋 270 - 5% open · ⏱️ 02.06.2023):
...
- [GitHub](https://github.com/graphistry/pygraphistry) (👨‍💻 37 · 🔀 190 · 📦 93 · 📋 280 - 49% open · ⏱️ 04.05.2023):

	```
	git clone https://github.com/graphistry/pygraphistry
	```
- [PyPi](https://pypi.org/project/graphistry) (📥 2.4K / month · 📦 5 · ⏱️ 02.07.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PGL) (👨‍💻 31 · 🔀 300 · 📦 44 · 📋 200 - 40% open · ⏱️ 17.05.2023):

	```
	git clone https://github.com/PaddlePaddle/PGL
	```
- [PyPi](https://pypi.org/project/pgl) (📥 1.1K / month · 📦 2 · ⏱️ 03.08.2022):
	```
	pip install pgl
	```
</details>
...
- [GitHub](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) (👨‍💻 26 · 🔀 300 · 📋 150 - 20% open · ⏱️ 18.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/torch-geometric-temporal) (📥 2.1K / month · 📦 4 · ⏱️ 04.09.2022):
	```
...
- [GitHub](https://github.com/graph4ai/graph4nlp) (👨‍💻 28 · 🔀 190 · 📋 170 - 6% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/graph4nlp) (📥 200 / month · ⏱️ 20.01.2022):
	```
...
- [GitHub](https://github.com/THUMNLab/AutoGL) (👨‍💻 15 · 🔀 110 · 📋 30 - 30% open · ⏱️ 30.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/auto-graph-learning) (📥 2 / month · ⏱️ 23.12.2020):
	```
...
- [GitHub](https://github.com/speechbrain/speechbrain) (👨‍💻 200 · 🔀 1.1K · 📦 760 · 📋 960 - 17% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/speechbrain/speechbrain
	```
- [PyPi](https://pypi.org/project/speechbrain) (📥 120K / month · 📦 11 · ⏱️ 29.08.2022):
	```
...
<details><summary><b><a href="https://github.com/coqui-ai/TTS">Coqui TTS</a></b> (🥈33 ·  ⭐ 12K) - - a deep learning toolkit for Text-to-Speech, battle-.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/coqui-ai/TTS) (👨‍💻 130 · 🔀 1.6K · 📥 930K · 📋 600 - 5% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/coqui-ai/TTS
	```
- [PyPi](https://pypi.org/project/tts) (📥 21K / month · 📦 12 · ⏱️ 21.06.2022):
	```
	pip install tts
	```
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥈33 ·  ⭐ 6K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 120 · 🔀 890 · 📋 1.1K - 4% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 2.6M / month · 📦 1.4K · ⏱️ 27.06.2022):
	```
	pip install librosa
	```
...
- [GitHub](https://github.com/deezer/spleeter) (👨‍💻 19 · 🔀 2.5K · 📥 2.4M · 📦 520 · 📋 750 - 26% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/deezer/spleeter
	```
- [PyPi](https://pypi.org/project/spleeter) (📥 17K / month · 📦 6 · ⏱️ 10.06.2022):
	```
...
- [GitHub](https://github.com/bastibe/python-soundfile) (👨‍💻 30 · 🔀 92 · 📥 15K · 📦 22K · 📋 220 - 41% open · ⏱️ 24.03.2023):

	```
	git clone https://github.com/bastibe/python-soundfile
	```
- [PyPi](https://pypi.org/project/soundfile) (📥 1.4M / month · 📦 140 · ⏱️ 03.02.2017):
	```
...
<details><summary><b><a href="https://github.com/Uberi/speech_recognition">SpeechRecognition</a></b> (🥈28 ·  ⭐ 7.2K · 📉) - Speech recognition module for Python, supporting.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/Picovoice/porcupine">Porcupine</a></b> (🥈28 ·  ⭐ 3K) - On-device wake word detection powered by deep learning. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Picovoice/porcupine) (👨‍💻 35 · 🔀 440 · 📦 19 · 📋 460 - 0% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/Picovoice/Porcupine
	```
- [PyPi](https://pypi.org/project/pvporcupine) (📥 3.3K / month · 📦 12 · ⏱️ 28.06.2022):
	```
...
- [GitHub](https://github.com/iver56/audiomentations) (👨‍💻 24 · 🔀 160 · 📦 280 · 📋 160 - 26% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/iver56/audiomentations
	```
- [PyPi](https://pypi.org/project/audiomentations) (📥 7.1K / month · 📦 4 · ⏱️ 15.06.2022):
	```
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 26 · 🔀 100 · 📦 790 · 📋 100 - 15% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/devsnd/tinytag
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 18K / month · 📦 100 · ⏱️ 12.03.2022):
	```
	pip install tinytag
	```
</details>
...
- [GitHub](https://github.com/magenta/ddsp) (👨‍💻 32 · 🔀 300 · 📦 40 · 📋 160 - 25% open · ⏱️ 25.05.2023):

	```
	git clone https://github.com/magenta/ddsp
	```
- [PyPi](https://pypi.org/project/ddsp) (📥 37K / month · 📦 1 · ⏱️ 25.05.2022):
	```
	pip install ddsp
	```
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 150 · 📥 23 · 📦 2.3K · 📋 96 - 14% open · ⏱️ 04.07.2022):

	```
	git clone https://github.com/keunwoochoi/kapre
	```
- [PyPi](https://pypi.org/project/kapre) (📥 1.6K / month · 📦 14 · ⏱️ 21.01.2022):
	```
	pip install kapre
	```
</details>
...
- [GitHub](https://github.com/KinWaiCheuk/nnAudio) (👨‍💻 14 · 🔀 83 · 📦 110 · 📋 59 - 28% open · ⏱️ 28.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/nnAudio) (📥 4.1K / month · 📦 3 · ⏱️ 24.12.2021):
	```
	pip install nnAudio
	```
</details>
<details><summary><b><a href="https://github.com/adefossez/julius">Julius</a></b> (🥉20 ·  ⭐ 340 · 💤) - Fast PyTorch based DSP for audio and 1D signals. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/adefossez/julius) (👨‍💻 2 · 🔀 24 · 📦 360 · 📋 11 - 18% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/julius) (📥 190K / month · 📦 6 · ⏱️ 20.09.2022):
	```
	pip install julius
	```
</details>
...
- [GitHub](https://github.com/visgl/deck.gl) (👨‍💻 230 · 🔀 2K · 📦 6K · 📋 2.7K - 7% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/visgl/deck.gl
	```
- [PyPi](https://pypi.org/project/pydeck) (📥 1.4M / month · 📦 35 · ⏱️ 25.10.2021):
	```
	pip install pydeck
	```
- [Conda](https://anaconda.org/conda-forge/pydeck) (📥 390K · ⏱️ 04.11.2022):
	...
	```
- [npm](https://www.npmjs.com/package/deck.gl) (📥 430K / month · 📦 450 · ⏱️ 05.06.2023):
	```
	npm install deck.gl
	```
</details>
...
<details><summary><b><a href="https://github.com/rasterio/rasterio">Rasterio</a></b> (🥇38 ·  ⭐ 2K) - Rasterio reads and writes geospatial raster datasets. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/rasterio/rasterio) (👨‍💻 150 · 🔀 520 · 📥 800 · 📦 7.9K · 📋 1.7K - 7% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/rasterio/rasterio
	```
- [PyPi](https://pypi.org/project/rasterio) (📥 1.6M / month · 📦 880 · ⏱️ 27.02.2019):
	```
	pip install rasterio
	```
- [Conda](https://anaconda.org/conda-forge/rasterio) (📥 2.3M · ⏱️ 02.06.2023):
	```
...
- [GitHub](https://github.com/Toblerity/Fiona) (👨‍💻 68 · 🔀 200 · 📦 13K · 📋 750 - 4% open · ⏱️ 23.05.2023):

	```
	git clone https://github.com/Toblerity/Fiona
	```
- [PyPi](https://pypi.org/project/fiona) (📥 5.2M / month · 📦 830 · ⏱️ 02.10.2018):
	```
	pip install fiona
	```
...
<details><summary><b><a href="https://github.com/Esri/arcgis-python-api">ArcGIS API</a></b> (🥈32 ·  ⭐ 1.6K) - Documentation and samples for ArcGIS API for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Esri/arcgis-python-api) (👨‍💻 88 · 🔀 1K · 📥 8.3K · 📋 600 - 9% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/Esri/arcgis-python-api
	```
- [PyPi](https://pypi.org/project/arcgis) (📥 91K / month · 📦 31 · ⏱️ 27.01.2023):
	```
	pip install arcgis
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 82 · 🔀 350 · 📦 4.5K · 📋 580 - 41% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/jupyter-widgets/ipyleaflet
	```
- [PyPi](https://pypi.org/project/ipyleaflet) (📥 130K / month · 📦 140 · ⏱️ 19.10.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipyleaflet) (📥 1M · ⏱️ 05.06.2023):
	...
	```
- [npm](https://www.npmjs.com/package/jupyter-leaflet) (📥 41K / month · 📦 5 · ⏱️ 02.06.2023):
	```
...
- [GitHub](https://github.com/geospace-code/pymap3d) (👨‍💻 15 · 🔀 79 · 📦 270 · 📋 50 - 12% open · ⏱️ 05.03.2023):

	```
	git clone https://github.com/geospace-code/pymap3d
	```
- [PyPi](https://pypi.org/project/pymap3d) (📥 58K / month · 📦 17 · ⏱️ 03.07.2022):
	```
	pip install pymap3d
	```
...
- [GitHub](https://github.com/bukosabino/ta) (👨‍💻 29 · 🔀 780 · 📦 2.2K · 📋 230 - 56% open · ⏱️ 23.08.2022):

	```
	git clone https://github.com/bukosabino/ta
	```
- [PyPi](https://pypi.org/project/ta) (📥 74K / month · 📦 42 · ⏱️ 23.08.2022):
	```
	pip install ta
	```
...
- [GitHub](https://github.com/jealous/stockstats) (👨‍💻 9 · 🔀 280 · 📦 860 · 📋 97 - 16% open · ⏱️ 10.02.2023):

	```
	git clone https://github.com/jealous/stockstats
	```
- [PyPi](https://pypi.org/project/stockstats) (📥 9.8K / month · 📦 29 · ⏱️ 19.11.2022):
	```
...
- [GitHub](https://github.com/google/tf-quant-finance) (👨‍💻 45 · 🔀 520 · 📋 61 - 54% open · ⏱️ 20.03.2023):

	```
	git clone https://github.com/google/tf-quant-finance
	```
- [PyPi](https://pypi.org/project/tf-quant-finance) (📥 1K / month · 📦 2 · ⏱️ 19.08.2022):
	```
...
<details><summary><b><a href="https://github.com/facebook/prophet">Prophet</a></b> (🥇36 ·  ⭐ 16K) - Tool for producing high quality forecasts for time series data that has.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebook/prophet) (👨‍💻 170 · 🔀 4.4K · 📥 1.7K · 📋 2K - 16% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/facebook/prophet
	```
- [PyPi](https://pypi.org/project/fbprophet) (📥 1.1M / month · 📦 130 · ⏱️ 05.09.2020):
	```
...
- [GitHub](https://github.com/ourownstory/neural_prophet) (👨‍💻 39 · 🔀 420 · 📦 250 · 📋 460 - 8% open · ⏱️ 24.05.2023):

	```
	git clone https://github.com/ourownstory/neural_prophet
	```
- [PyPi](https://pypi.org/project/neuralprophet) (📥 160K / month · 📦 3 · ⏱️ 22.03.2022):
	```
...
- [GitHub](https://github.com/unit8co/darts) (👨‍💻 92 · 🔀 670 · 📦 290 · 📋 1.1K - 22% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/unit8co/darts
	```
- [PyPi](https://pypi.org/project/u8darts) (📥 14K / month · 📦 5 · ⏱️ 22.06.2022):
	```
	pip install u8darts
	```
...
- [GitHub](https://github.com/Nixtla/statsforecast) (👨‍💻 21 · 🔀 180 · 📦 300 · 📋 170 - 44% open · ⏱️ 07.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/statsforecast) (📥 340K / month · 📦 19 · ⏱️ 27.06.2022):
	```
...
<details><summary><b><a href="https://github.com/jdb78/pytorch-forecasting">pytorch-forecasting</a></b> (🥈29 ·  ⭐ 2.9K) - Time series forecasting with PyTorch. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jdb78/pytorch-forecasting) (👨‍💻 35 · 🔀 480 · 📋 670 - 59% open · ⏱️ 10.04.2023):

	```
	git clone https://github.com/jdb78/pytorch-forecasting
	```
- [PyPi](https://pypi.org/project/pytorch-forecasting) (📥 63K / month · 📦 8 · ⏱️ 26.07.2020):
	```
...
<details><summary><b><a href="https://github.com/Nixtla/neuralforecast">NeuralForecast</a></b> (🥈28 ·  ⭐ 1.5K) - Scalable and user friendly neural forecasting algorithms. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Nixtla/neuralforecast) (👨‍💻 25 · 🔀 150 · 📦 23 · 📋 280 - 19% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/Nixtla/neuralforecast
	```
- [PyPi](https://pypi.org/project/neuralforecast) (📥 6.7K / month · 📦 3 · ⏱️ 02.06.2022):
	```
	pip install neuralforecast
	```
- [Conda](https://anaconda.org/conda-forge/neuralforecast) (📥 7.1K · ⏱️ 22.04.2023):
	```
...
- [GitHub](https://github.com/uber/orbit) (👨‍💻 18 · 🔀 120 · 📦 27 · 📋 380 - 15% open · ⏱️ 29.01.2023):
...
- [PyPi](https://pypi.org/project/orbit-ml) (📥 130K / month · 📦 1 · ⏱️ 29.01.2023):
	...
	```
- [Conda](https://anaconda.org/conda-forge/orbit-ml) (📥 3.4K · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/linkedin/greykite) (👨‍💻 9 · 🔀 97 · 📥 1 · 📦 19 · 📋 92 - 18% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/linkedin/greykite
	```
- [PyPi](https://pypi.org/project/greykite) (📥 13K / month · ⏱️ 15.07.2022):
	```
...
- [GitHub](https://github.com/linkedin/luminol) (👨‍💻 9 · 🔀 220 · 📦 75 · 📋 43 - 72% open · ⏱️ 09.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/luminol) (📥 9.7K / month · 📦 15 · ⏱️ 11.12.2017):
	```
	pip install luminol
	```
</details>
...
- [GitHub](https://github.com/dmbee/seglearn) (👨‍💻 14 · 🔀 64 · 📦 39 · 📋 29 - 17% open · ⏱️ 27.08.2022):

	```
	git clone https://github.com/dmbee/seglearn
	```
- [PyPi](https://pypi.org/project/seglearn) (📥 2.5K / month · 📦 2 · ⏱️ 13.03.2021):
	```
...
- <b><a href="https://github.com/predict-idlab/tsflex">tsflex</a></b> (🥉19 ·  ⭐ 290) - Flexible time series feature extraction & processing. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/hsbc/tslumen">tslumen</a></b> (🥉6 ·  ⭐ 48 · 💤) - A library for Time Series EDA (exploratory data analysis). <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
</details>
<br>
...
- [GitHub](https://github.com/mne-tools/mne-python) (👨‍💻 340 · 🔀 1.2K · 📦 2.7K · 📋 4.5K - 11% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/mne-tools/mne-python
	```
- [PyPi](https://pypi.org/project/mne) (📥 62K / month · 📦 250 · ⏱️ 12.05.2022):
	```
	pip install mne
	```
...
- [GitHub](https://github.com/Project-MONAI/MONAI) (👨‍💻 150 · 🔀 790 · 📦 1K · 📋 2.6K - 11% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/Project-MONAI/MONAI
	```
- [PyPi](https://pypi.org/project/monai) (📥 87K / month · 📦 37 · ⏱️ 13.06.2022):
	```
	pip install monai
	```
...
<details><summary><b><a href="https://github.com/nilearn/nilearn">Nilearn</a></b> (🥇35 ·  ⭐ 1K) - Machine learning for NeuroImaging in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/nilearn/nilearn) (👨‍💻 210 · 🔀 500 · 📥 120 · 📦 2.3K · 📋 1.8K - 15% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/nilearn/nilearn
	```
- [PyPi](https://pypi.org/project/nilearn) (📥 34K / month · 📦 260 · ⏱️ 13.04.2022):
	```
	pip install nilearn
	```
- [Conda](https://anaconda.org/conda-forge/nilearn) (📥 230K · ⏱️ 02.05.2023):
	```
...
- [GitHub](https://github.com/nipy/nipype) (👨‍💻 240 · 🔀 510 · 📦 1.5K · 📋 1.3K - 29% open · ⏱️ 28.05.2023):

	```
	git clone https://github.com/nipy/nipype
	```
- [PyPi](https://pypi.org/project/nipype) (📥 74K / month · 📦 160 · ⏱️ 21.05.2017):
	```
	pip install nipype
	```
...
- [GitHub](https://github.com/dipy/dipy) (👨‍💻 140 · 🔀 370 · 📦 800 · 📋 850 - 17% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/dipy/dipy
	```
- [PyPi](https://pypi.org/project/dipy) (📥 12K / month · 📦 89 · ⏱️ 11.03.2022):
	```
	pip install dipy
	```
- [Conda](https://anaconda.org/conda-forge/dipy) (📥 390K · ⏱️ 26.04.2023):
	```
...
- [GitHub](https://github.com/CamDavidsonPilon/lifelines) (👨‍💻 110 · 🔀 530 · 📦 1.6K · 📋 910 - 26% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/CamDavidsonPilon/lifelines
	```
- [PyPi](https://pypi.org/project/lifelines) (📥 370K / month · 📦 120 · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/hail-is/hail) (👨‍💻 87 · 🔀 230 · 📦 100 · 📋 2.1K - 4% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/hail-is/hail
	```
- [PyPi](https://pypi.org/project/hail) (📥 36K / month · 📦 15 · ⏱️ 07.07.2022):
	```
	pip install hail
	```
</details>
<details><summary><b><a href="https://github.com/nipy/nibabel">NiBabel</a></b> (🥈33 ·  ⭐ 560) - Python package to access a cacophony of neuro-imaging file formats. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nipy/nibabel) (👨‍💻 96 · 🔀 250 · 📦 11K · 📋 500 - 24% open · ⏱️ 23.04.2023):

	```
	git clone https://github.com/nipy/nibabel
	```
- [PyPi](https://pypi.org/project/nibabel) (📥 240K / month · 📦 1.1K · ⏱️ 18.06.2022):
	```
	pip install nibabel
	```
- [Conda](https://anaconda.org/conda-forge/nibabel) (📥 590K · ⏱️ 07.04.2023):
	```
...
- [GitHub](https://github.com/google/deepvariant) (👨‍💻 26 · 🔀 670 · 📥 4.7K · 📋 600 - 1% open · ⏱️ 28.02.2023):
...
- [GitHub](https://github.com/nipy/nipy) (👨‍💻 66 · 🔀 130 · 📋 160 - 28% open · ⏱️ 05.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/nipy) (📥 1.2K / month · 📦 50 · ⏱️ 29.03.2021):
	```
	pip install nipy
	```
...
- <b><a href="https://github.com/brainiak/brainiak">Brainiak</a></b> (🥉20 ·  ⭐ 300 · 💀) - Brain Imaging Analysis Kit. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/perone/medicaltorch">MedicalTorch</a></b> (🥉15 ·  ⭐ 820 · 💀) - A medical imaging framework for Pytorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/carefree0910/carefree-learn">carefree-learn</a></b> (🥇23 ·  ⭐ 400) - Deep Learning PyTorch. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/carefree0910/carefree-learn) (👨‍💻 1 · 🔀 37 · 📦 3 · 📋 82 - 2% open · ⏱️ 07.06.2023):
...
- [GitHub](https://github.com/manujosephv/pytorch_tabular) (👨‍💻 15 · 🔀 100 · 📥 9 · 📋 110 - 12% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/manujosephv/pytorch_tabular
	```
- [PyPi](https://pypi.org/project/pytorch_tabular) (📥 1.9K / month · 📦 2 · ⏱️ 01.09.2021):
	```
...
- <b><a href="https://github.com/AnotherSamWilson/miceforest">miceforest</a></b> (🥈21 ·  ⭐ 240) - Multiple Imputation with LightGBM in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/firmai/deltapy">deltapy</a></b> (🥉12 ·  ⭐ 500 · 💀) - DeltaPy - Tabular Data Augmentation (by @firmai). <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
<br>
...
- [GitHub](https://github.com/PaddlePaddle/PaddleOCR) (👨‍💻 150 · 🔀 6.3K · 📦 1.5K · 📋 7.5K - 24% open · ⏱️ 29.05.2023):

	```
	git clone https://github.com/PaddlePaddle/PaddleOCR
	```
- [PyPi](https://pypi.org/project/paddleocr) (📥 46K / month · 📦 23 · ⏱️ 14.12.2022):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 120 · 🔀 2.6K · 📥 4.8M · 📦 2.9K · 📋 800 - 28% open · ⏱️ 25.05.2023):

	```
	git clone https://github.com/JaidedAI/EasyOCR
	```
- [PyPi](https://pypi.org/project/easyocr) (📥 110K / month · 📦 60 · ⏱️ 20.09.2022):
	```
	pip install easyocr
	```
</details>
<details><summary><b><a href="https://github.com/ocrmypdf/OCRmyPDF">OCRmyPDF</a></b> (🥈33 ·  ⭐ 9K) - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/ocrmypdf/OCRmyPDF) (👨‍💻 81 · 🔀 710 · 📦 540 · 📋 970 - 10% open · ⏱️ 03.06.2023):

	```
	git clone https://github.com/ocrmypdf/OCRmyPDF
	```
- [PyPi](https://pypi.org/project/ocrmypdf) (📥 38K / month · 📦 17 · ⏱️ 04.07.2022):
	```
...
<details><summary><b><a href="https://github.com/madmaze/pytesseract">Tesseract</a></b> (🥈31 ·  ⭐ 4.9K · 📈) - Python-tesseract is an optical character recognition (OCR).. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 43 · 🔀 650 · 📋 340 - 8% open · ⏱️ 14.05.2023):

	```
	git clone https://github.com/madmaze/pytesseract
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 970K / month · 📦 1.1K · ⏱️ 16.08.2022):
	```
...
- [GitHub](https://github.com/open-mmlab/mmocr) (👨‍💻 78 · 🔀 650 · 📦 54 · 📋 840 - 14% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/open-mmlab/mmocr
	```
- [PyPi](https://pypi.org/project/mmocr) (📥 8.7K / month · 📦 2 · ⏱️ 05.05.2022):
	```
	pip install mmocr
	```
</details>
<details><summary><b><a href="https://github.com/sirfz/tesserocr">tesserocr</a></b> (🥈30 ·  ⭐ 1.8K) - A Python wrapper for the tesseract-ocr API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 29 · 🔀 240 · 📦 840 · 📋 260 - 30% open · ⏱️ 16.04.2023):

	```
	git clone https://github.com/sirfz/tesserocr
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 40K / month · 📦 69 · ⏱️ 19.06.2021):
	```
...
<details><summary><b><a href="https://github.com/faustomorales/keras-ocr">keras-ocr</a></b> (🥉25 ·  ⭐ 1.2K) - A packaged and flexible version of the CRAFT text detector and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/faustomorales/keras-ocr) (👨‍💻 17 · 🔀 300 · 📥 560K · 📦 260 · 📋 190 - 42% open · ⏱️ 24.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/keras-ocr) (📥 9.6K / month · 📦 5 · ⏱️ 24.12.2022):
	```
...
- [GitHub](https://github.com/WZBSocialScienceCenter/pdftabextract) (👨‍💻 3 · 🔀 350 · 📦 43 · 📋 21 - 14% open · ⏱️ 24.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pdftabextract) (📥 240 / month · 📦 1 · ⏱️ 09.01.2018):
	```
...
- [GitHub](https://github.com/Calamari-OCR/calamari) (👨‍💻 20 · 🔀 200 · 📋 260 - 21% open · ⏱️ 22.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/calamari_ocr) (📥 1.7K / month · 📦 2 · ⏱️ 13.11.2018):
	```
...
- [GitHub](https://github.com/ray-project/ray) (👨‍💻 870 · 🔀 4.5K · 📥 83 · 📦 10K · 📋 14K - 20% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/ray-project/ray
	```
- [PyPi](https://pypi.org/project/ray) (📥 2.2M / month · 📦 450 · ⏱️ 29.08.2018):
	```
	pip install ray
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 50K · 📋 4.9K - 18% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 7.7M / month · 📦 2.9K · ⏱️ 18.08.2016):
	```
	pip install dask
	```
...
- [GitHub](https://github.com/dask/distributed) (👨‍💻 310 · 🔀 700 · 📦 29K · 📋 3.6K - 38% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/dask/distributed
	```
- [PyPi](https://pypi.org/project/distributed) (📥 4.9M / month · 📦 1.2K · ⏱️ 27.01.2023):
	```
...
<details><summary><b><a href="https://github.com/microsoft/DeepSpeed">DeepSpeed</a></b> (🥇39 ·  ⭐ 26K) - DeepSpeed is a deep learning optimization library that makes.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/microsoft/DeepSpeed) (👨‍💻 200 · 🔀 3K · 📦 1.6K · 📋 1.8K - 47% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/microsoft/DeepSpeed
	```
- [PyPi](https://pypi.org/project/deepspeed) (📥 290K / month · 📦 54 · ⏱️ 17.01.2023):
	```
...
- [GitHub](https://github.com/horovod/horovod) (👨‍💻 170 · 🔀 2.2K · 📦 920 · 📋 2.2K - 15% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/horovod/horovod
	```
- [PyPi](https://pypi.org/project/horovod) (📥 71K / month · 📦 31 · ⏱️ 21.06.2022):
	```
	pip install horovod
	```
</details>
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 2K · 📋 9.1K - 30% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/h2oai/h2o-3
	```
- [PyPi](https://pypi.org/project/h2o) (📥 370K / month · 📦 80 · ⏱️ 05.01.2023):
	```
	pip install h2o
	```
</details>
...
- [GitHub](https://github.com/intel-analytics/BigDL) (👨‍💻 180 · 🔀 1.1K · 📦 42 · 📋 1.9K - 38% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/intel-analytics/BigDL
	```
- [PyPi](https://pypi.org/project/bigdl) (📥 9.7K / month · 📦 1 · ⏱️ 07.07.2022):
	```
	pip install bigdl
	```
...
- [GitHub](https://github.com/Lightning-AI/torchmetrics) (👨‍💻 200 · 🔀 300 · 📥 1.8K · 📦 12K · 📋 620 - 8% open · ⏱️ 06.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/metrics) (📥 5.7K / month · 📦 14 · ⏱️ 28.04.2018):
	```
	pip install metrics
	```
...
- [GitHub](https://github.com/hpcaitech/ColossalAI) (👨‍💻 130 · 🔀 3.5K · 📦 240 · 📋 1.1K - 26% open · ⏱️ 08.06.2023):
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 110 · 🔀 730 · 📋 660 - 41% open · ⏱️ 08.06.2023):
...
- [GitHub](https://github.com/maxpumperla/elephas) (👨‍💻 27 · 🔀 310 · 📦 71 · 📋 160 - 4% open · ⏱️ 31.08.2022):

	```
	git clone https://github.com/maxpumperla/elephas
	```
- [PyPi](https://pypi.org/project/elephas) (📥 70K / month · 📦 3 · ⏱️ 04.03.2023):
	```
	pip install elephas
	```
...
- [GitHub](https://github.com/dask/dask-ml) (👨‍💻 77 · 🔀 240 · 📦 820 · 📋 520 - 51% open · ⏱️ 24.03.2023):

	```
	git clone https://github.com/dask/dask-ml
	```
- [PyPi](https://pypi.org/project/dask-ml) (📥 160K / month · 📦 62 · ⏱️ 06.05.2020):
	```
	pip install dask-ml
	```
...
- [GitHub](https://github.com/mpi4py/mpi4py) (👨‍💻 24 · 🔀 97 · 📥 13K · 📋 120 - 8% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/mpi4py/mpi4py
	```
- [PyPi](https://pypi.org/project/mpi4py) (📥 160K / month · 📦 700 · ⏱️ 02.11.2022):
	```
	pip install mpi4py
	```
...
- [GitHub](https://github.com/uber/petastorm) (👨‍💻 48 · 🔀 280 · 📥 390 · 📦 120 · 📋 320 - 53% open · ⏱️ 03.02.2023):

	```
	git clone https://github.com/uber/petastorm
	```
- [PyPi](https://pypi.org/project/petastorm) (📥 39K / month · 📦 8 · ⏱️ 03.02.2023):
	```
...
- [GitHub](https://github.com/yahoo/TensorFlowOnSpark) (👨‍💻 34 · 🔀 960 · 📋 360 - 2% open · ⏱️ 27.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorflowonspark) (📥 310K / month · 📦 5 · ⏱️ 21.04.2022):
	```
...
- [GitHub](https://github.com/tensorflow/mesh) (👨‍💻 50 · 🔀 240 · 📦 820 · 📋 110 - 87% open · ⏱️ 16.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/mesh-tensorflow) (📥 29K / month · 📦 33 · ⏱️ 15.05.2022):
	```
...
- [GitHub](https://github.com/facebookincubator/submitit) (👨‍💻 23 · 🔀 100 · 📦 1.3K · 📋 100 - 31% open · ⏱️ 28.09.2022):

	```
	git clone https://github.com/facebookincubator/submitit
	```
- [PyPi](https://pypi.org/project/submitit) (📥 140K / month · 📦 7 · ⏱️ 08.04.2021):
	```
...
- [GitHub](https://github.com/learning-at-home/hivemind) (👨‍💻 28 · 🔀 99 · 📦 61 · 📋 150 - 34% open · ⏱️ 26.04.2023):

	```
	git clone https://github.com/learning-at-home/hivemind
	```
- [PyPi](https://pypi.org/project/hivemind) (📥 1.7K / month · 📦 4 · ⏱️ 20.06.2022):
	```
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 110 · 🔀 740 · 📋 680 - 43% open · ⏱️ 08.06.2023):
...
- <b><a href="https://github.com/peterwittek/somoclu">somoclu</a></b> (🥉21 ·  ⭐ 250 · 💤) - Massively parallel self-organizing maps: accelerate training on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/Bluefog-Lib/bluefog">bluefog</a></b> (🥉15 ·  ⭐ 290) - Distributed and decentralized training framework for PyTorch.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/microsoft/nni">NNI</a></b> (🥇37 ·  ⭐ 13K) - An open source AutoML toolkit for automate machine learning lifecycle,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/nni) (👨‍💻 190 · 🔀 1.8K · 📦 400 · 📋 1.9K - 14% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/microsoft/nni
	```
- [PyPi](https://pypi.org/project/nni) (📥 13K / month · 📦 34 · ⏱️ 22.06.2022):
	```
	pip install nni
	```
</details>
...
- [GitHub](https://github.com/keras-team/autokeras) (👨‍💻 140 · 🔀 1.4K · 📥 16K · 📦 500 · 📋 880 - 14% open · ⏱️ 02.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/autokeras) (📥 13K / month · 📦 11 · ⏱️ 30.04.2022):
	```
...
- [GitHub](https://github.com/bayesian-optimization/BayesianOptimization) (👨‍💻 40 · 🔀 1.4K · 📥 120 · 📦 1.9K · 📋 310 - 3% open · ⏱️ 25.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/bayesian-optimization) (📥 190K / month · 📦 98 · ⏱️ 04.12.2022):
	```
...
- [GitHub](https://github.com/pytorch/botorch) (👨‍💻 92 · 🔀 320 · 📦 560 · 📋 420 - 15% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/pytorch/botorch
	```
- [PyPi](https://pypi.org/project/botorch) (📥 180K / month · 📦 28 · ⏱️ 21.04.2022):
	```
	pip install botorch
	```
...
- [GitHub](https://github.com/automl/auto-sklearn) (👨‍💻 88 · 🔀 1.2K · 📥 46 · 📦 450 · 📋 980 - 16% open · ⏱️ 18.04.2023):

	```
	git clone https://github.com/automl/auto-sklearn
	```
- [PyPi](https://pypi.org/project/auto-sklearn) (📥 36K / month · 📦 39 · ⏱️ 20.09.2022):
	```
...
- [GitHub](https://github.com/autogluon/autogluon) (👨‍💻 100 · 🔀 740 · 📦 2 · 📋 1K - 22% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/autogluon/autogluon
	```
- [PyPi](https://pypi.org/project/autogluon) (📥 59K / month · 📦 7 · ⏱️ 07.07.2022):
	```
	pip install autogluon
	```
- [Docker Hub](https://hub.docker.com/r/autogluon/autogluon) (📥 3.3K · ⭐ 11 · ⏱️ 17.03.2023):
	```
...
<details><summary><b><a href="https://github.com/maxpumperla/hyperas">Hyperas</a></b> (🥈27 ·  ⭐ 2.2K) - Keras + Hyperopt: A very simple wrapper for convenient.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/maxpumperla/hyperas) (👨‍💻 22 · 🔀 320 · 📦 300 · 📋 260 - 37% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/SheffieldML/GPyOpt) (👨‍💻 49 · 🔀 250 · 📦 440 · 📋 290 - 35% open · ⏱️ 17.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/gpyopt) (📥 8.5K / month · 📦 37 · ⏱️ 19.03.2020):
	```
	pip install gpyopt
	```
</details>
...
- [GitHub](https://github.com/shankarpandala/lazypredict) (👨‍💻 17 · 🔀 230 · 📦 560 · 📋 100 - 64% open · ⏱️ 28.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/lazypredict) (📥 22K / month · 📦 1 · ⏱️ 28.09.2022):
	```
...
<details><summary><b><a href="https://github.com/aimclub/FEDOT">FEDOT</a></b> (🥉23 ·  ⭐ 540) - Automated modeling and machine learning framework FEDOT. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/aimclub/FEDOT) (👨‍💻 27 · 🔀 73 · 📦 31 · 📋 460 - 20% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/nccr-itmo/FEDOT
	```
- [PyPi](https://pypi.org/project/fedot) (📥 760 / month · ⏱️ 28.03.2022):
	```
	pip install fedot
	```
</details>
...
- [GitHub](https://github.com/SimonBlanke/Hyperactive) (👨‍💻 7 · 🔀 39 · 📥 120 · 📋 60 - 18% open · ⏱️ 23.05.2023):

	```
	git clone https://github.com/SimonBlanke/Hyperactive
	```
- [PyPi](https://pypi.org/project/hyperactive) (📥 1.5K / month · 📦 5 · ⏱️ 04.05.2022):
	```
...
- [GitHub](https://github.com/nidhaloff/igel) (👨‍💻 20 · 🔀 160 · 📥 37 · 📦 4 · 📋 50 - 12% open · ⏱️ 08.04.2023):

	```
	git clone https://github.com/nidhaloff/igel
	```
- [PyPi](https://pypi.org/project/igel) (📥 36 / month · ⏱️ 18.06.2021):
	```
	pip install igel
	```
</details>
...
- [GitHub](https://github.com/ScottfreeLLC/AlphaPy) (👨‍💻 4 · 🔀 180 · 📦 3 · 📋 42 - 30% open · ⏱️ 17.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/alphapy) (📥 140 / month · ⏱️ 29.08.2020):
	```
	pip install alphapy
	```
</details>
...
- [GitHub](https://github.com/gugarosa/opytimizer) (👨‍💻 4 · 🔀 36 · 📦 15 · ⏱️ 11.05.2023):

	```
	git clone https://github.com/gugarosa/opytimizer
	```
- [PyPi](https://pypi.org/project/opytimizer) (📥 250 / month · ⏱️ 04.05.2022):
	```
	pip install opytimizer
	```
</details>
<details><summary><b><a href="https://github.com/cerlymarco/shap-hypetune">shap-hypetune</a></b> (🥉17 ·  ⭐ 460 · 💤) - A python package for simultaneous Hyperparameters Tuning and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/cerlymarco/shap-hypetune) (👨‍💻 2 · 🔀 57 · 📦 13 · 📋 25 - 4% open · ⏱️ 24.08.2022):

	```
	git clone https://github.com/cerlymarco/shap-hypetune
	```
- [PyPi](https://pypi.org/project/shap-hypetune) (📥 3.2K / month):
	```
...
- <b><a href="https://github.com/automl/SMAC3">SMAC3</a></b> (🥈27 ·  ⭐ 850) - SMAC3: A Versatile Bayesian Optimization Package for.. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
- <b><a href="https://github.com/Epistimio/orion">Orion</a></b> (🥈26 ·  ⭐ 260) - Asynchronous Distributed Hyperparameter Optimization. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/mindsdb/lightwood">lightwood</a></b> (🥉22 ·  ⭐ 370) - Lightwood is Legos for Machine Learning. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/google/model_search">model_search</a></b> (🥉11 ·  ⭐ 3.2K · 💀) - AutoML algorithms for model architecture search at scale. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 8.5K · 📦 43K · 📋 1.8K - 3% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 480K / month · 📦 2.6K · ⏱️ 04.10.2022):
	```
	pip install gym
	```
...
- [GitHub](https://github.com/tensorflow/agents) (👨‍💻 140 · 🔀 690 · 📦 1.2K · 📋 640 - 28% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/tensorflow/agents
	```
- [PyPi](https://pypi.org/project/tf-agents) (📥 120K / month · 📦 3 · ⏱️ 17.01.2019):
	```
	pip install tf-agents
	```
</details>
<details><summary><b><a href="https://github.com/AI4Finance-Foundation/FinRL">FinRL</a></b> (🥇31 ·  ⭐ 7.5K) - FinRL: Financial Reinforcement Learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/AI4Finance-Foundation/FinRL) (👨‍💻 95 · 🔀 1.8K · 📦 20 · 📋 610 - 23% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/AI4Finance-Foundation/FinRL
	```
- [PyPi](https://pypi.org/project/finrl) (📥 1.8K / month · ⏱️ 08.01.2022):
	```
	pip install finrl
	```
</details>
<details><summary><b><a href="https://github.com/Farama-Foundation/ViZDoom">ViZDoom</a></b> (🥈30 ·  ⭐ 1.5K) - Reinforcement Learning environments based on the 1993 game Doom. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Farama-Foundation/ViZDoom) (👨‍💻 52 · 🔀 360 · 📥 12K · 📦 190 · 📋 450 - 11% open · ⏱️ 12.05.2023):
...
- [GitHub](https://github.com/deepmind/acme) (👨‍💻 83 · 🔀 400 · 📦 140 · 📋 260 - 21% open · ⏱️ 26.04.2023):

	```
	git clone https://github.com/deepmind/acme
	```
- [PyPi](https://pypi.org/project/dm-acme) (📥 2.8K / month · 📦 3 · ⏱️ 10.02.2022):
	```
	pip install dm-acme
	```
...
- [GitHub](https://github.com/google/dopamine) (👨‍💻 15 · 🔀 1.4K · 📋 180 - 52% open · ⏱️ 20.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/dopamine-rl) (📥 47K / month · 📦 39 · ⏱️ 21.09.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PARL) (👨‍💻 41 · 🔀 810 · 📦 110 · 📋 490 - 20% open · ⏱️ 19.05.2023):

	```
	git clone https://github.com/PaddlePaddle/PARL
	```
- [PyPi](https://pypi.org/project/parl) (📥 610 / month · 📦 1 · ⏱️ 13.05.2022):
	```
	pip install parl
	```
</details>
...
- [GitHub](https://github.com/rlworkgroup/garage) (👨‍💻 79 · 🔀 290 · 📦 84 · 📋 1K - 22% open · ⏱️ 04.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/garage) (📥 820 / month · 📦 2 · ⏱️ 23.03.2021):
	```
	pip install garage
	```
</details>
...
- [GitHub](https://github.com/hill-a/stable-baselines) (👨‍💻 110 · 🔀 710 · 📋 940 - 13% open · ⏱️ 04.09.2022):

	```
	git clone https://github.com/hill-a/stable-baselines
	```
- [PyPi](https://pypi.org/project/stable-baselines) (📥 6.9K / month · 📦 35 · ⏱️ 06.04.2021):
	```
	pip install stable-baselines
	```
</details>
<details><summary><b><a href="https://github.com/deepmind/rlax">RLax</a></b> (🥉24 ·  ⭐ 1K) - A library of reinforcement learning building blocks in JAX. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deepmind/rlax) (👨‍💻 21 · 🔀 75 · 📦 140 · 📋 33 - 45% open · ⏱️ 09.05.2023):
...
- [GitHub](https://github.com/facebookresearch/ReAgent) (👨‍💻 160 · 🔀 490 · 📋 140 - 47% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/facebookresearch/ReAgent
	```
- [PyPi](https://pypi.org/project/reagent) (📥 18 / month · ⏱️ 27.05.2020):
	```
	pip install reagent
	```
</details>
...
- [GitHub](https://github.com/tensorforce/tensorforce) (👨‍💻 82 · 🔀 540 · 📋 660 - 4% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorforce) (📥 760 / month · 📦 2 · ⏱️ 30.08.2021):
	```
...
- [GitHub](https://github.com/pfnet/pfrl) (👨‍💻 18 · 🔀 140 · 📦 84 · 📋 73 - 45% open · ⏱️ 21.09.2022):

	```
	git clone https://github.com/pfnet/pfrl
	```
- [PyPi](https://pypi.org/project/pfrl) (📥 330 / month · 📦 1 · ⏱️ 07.07.2021):
	```
	pip install pfrl
	```
</details>
...
- [GitHub](https://github.com/microsoft/recommenders) (👨‍💻 120 · 🔀 2.7K · 📥 340 · 📦 73 · 📋 770 - 21% open · ⏱️ 22.04.2023):

	```
	git clone https://github.com/microsoft/recommenders
	```
- [PyPi](https://pypi.org/project/recommenders) (📥 42K / month · 📦 2 · ⏱️ 01.04.2022):
	```
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 47 · 🔀 660 · 📦 1.1K · 📋 490 - 27% open · ⏱️ 30.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/lightfm) (📥 360K / month · 📦 47 · ⏱️ 27.11.2020):
	```
	pip install lightfm
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 590 · 📥 390 · 📦 1K · 📋 460 - 17% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/benfred/implicit
	```
- [PyPi](https://pypi.org/project/implicit) (📥 140K / month · 📦 38 · ⏱️ 11.12.2022):
	```
...
- [GitHub](https://github.com/tensorflow/ranking) (👨‍💻 32 · 🔀 460 · 📋 310 - 24% open · ⏱️ 03.06.2023):

	```
	git clone https://github.com/tensorflow/ranking
	```
- [PyPi](https://pypi.org/project/tensorflow_ranking) (📥 150K / month · 📦 14 · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/tensorflow/recommenders) (👨‍💻 42 · 🔀 240 · 📦 220 · 📋 400 - 56% open · ⏱️ 27.04.2023):

	```
	git clone https://github.com/tensorflow/recommenders
	```
- [PyPi](https://pypi.org/project/tensorflow-recommenders) (📥 330K / month · 📦 1 · ⏱️ 23.08.2021):
	```
...
- [GitHub](https://github.com/PreferredAI/cornac) (👨‍💻 16 · 🔀 120 · 📦 160 · 📋 120 - 10% open · ⏱️ 13.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/cornac) (📥 61K / month · 📦 16 · ⏱️ 23.12.2018):
	```
	pip install cornac
	```
...
<details><summary><b><a href="https://github.com/pytorch/torchrec">torchrec</a></b> (🥉26 ·  ⭐ 1.4K) - Pytorch domain library for recommendation systems. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pytorch/torchrec) (👨‍💻 160 · 🔀 260 · 📋 190 - 61% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/pytorch/torchrec
	```
- [PyPi](https://pypi.org/project/torchrec-nightly-cpu) (📥 430 / month · ⏱️ 12.05.2022):
	```
...
- [GitHub](https://github.com/RUCAIBox/RecBole) (👨‍💻 63 · 🔀 500 · 📋 740 - 15% open · ⏱️ 19.05.2023):

	```
	git clone https://github.com/RUCAIBox/RecBole
	```
- [PyPi](https://pypi.org/project/recbole) (📥 3.8K / month · 📦 2 · ⏱️ 25.02.2022):
	```
	pip install recbole
	```
...
<details><summary><b><a href="https://github.com/statisticianinstilettos/recmetrics">recmetrics</a></b> (🥉19 ·  ⭐ 510) - A library of metrics for evaluating recommender systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/statisticianinstilettos/recmetrics) (👨‍💻 19 · 🔀 94 · 📥 3 · 📦 41 · 📋 22 - 36% open · ⏱️ 17.03.2023):

	```
	git clone https://github.com/statisticianinstilettos/recmetrics
	```
- [PyPi](https://pypi.org/project/recmetrics) (📥 4.7K / month · ⏱️ 26.04.2022):
	```
...
- <b><a href="https://github.com/ShopRunner/collie">Collie</a></b> (🥉18 ·  ⭐ 100) - A library for preparing, training, and evaluating scalable deep.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/OpenMined/PySyft) (👨‍💻 490 · 🔀 1.9K · 📋 3.4K - 4% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/OpenMined/PySyft
	```
- [PyPi](https://pypi.org/project/syft) (📥 6.2K / month · 📦 5 · ⏱️ 29.06.2022):
	```
	pip install syft
	```
</details>
...
- [GitHub](https://github.com/pytorch/opacus) (👨‍💻 69 · 🔀 290 · 📥 79 · 📦 600 · 📋 250 - 26% open · ⏱️ 18.04.2023):

	```
	git clone https://github.com/pytorch/opacus
	```
- [PyPi](https://pypi.org/project/opacus) (📥 31K / month · 📦 18 · ⏱️ 06.05.2022):
	```
	pip install opacus
	```
...
- [GitHub](https://github.com/tensorflow/privacy) (👨‍💻 53 · 🔀 420 · 📥 110 · 📋 190 - 54% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/tensorflow/privacy
	```
- [PyPi](https://pypi.org/project/tensorflow-privacy) (📥 20K / month · 📦 14 · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/FederatedAI/FATE) (👨‍💻 92 · 🔀 1.5K · 📋 1.7K - 42% open · ⏱️ 02.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/ETAF) (📥 5 / month · ⏱️ 06.05.2020):
	```
	pip install ETAF
	```
</details>
...
- [GitHub](https://github.com/tf-encrypted/tf-encrypted) (👨‍💻 29 · 🔀 200 · 📦 64 · 📋 430 - 32% open · ⏱️ 08.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/tf-encrypted) (📥 530 / month · 📦 9 · ⏱️ 16.11.2022):
	```
	pip install tf-encrypted
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/CrypTen">CrypTen</a></b> (🥉23 ·  ⭐ 1.3K) - A framework for Privacy Preserving Machine Learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/facebookresearch/CrypTen) (👨‍💻 32 · 🔀 220 · 📦 30 · 📋 230 - 22% open · ⏱️ 29.04.2023):

	```
	git clone https://github.com/facebookresearch/CrypTen
	```
- [PyPi](https://pypi.org/project/crypten) (📥 270 / month · 📦 2 · ⏱️ 08.12.2022):
	```
	pip install crypten
	```
</details>
...
- [GitHub](https://github.com/mlflow/mlflow) (👨‍💻 590 · 🔀 3.4K · 📦 20K · 📋 3.1K - 36% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/mlflow/mlflow
	```
- [PyPi](https://pypi.org/project/mlflow) (📥 10M / month · 📦 430 · ⏱️ 03.03.2020):
	```
	pip install mlflow
	```
...
- [GitHub](https://github.com/tensorflow/tensorboard) (👨‍💻 300 · 🔀 1.6K · 📦 170K · 📋 1.8K - 34% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/tensorflow/tensorboard
	```
- [PyPi](https://pypi.org/project/tensorboard) (📥 19M / month · 📦 2.6K · ⏱️ 13.01.2023):
	```
...
- [GitHub](https://github.com/iterative/dvc) (👨‍💻 280 · 🔀 1.1K · 📥 110K · 📦 7.7K · 📋 4.3K - 13% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/iterative/dvc
	```
- [PyPi](https://pypi.org/project/dvc) (📥 700K / month · 📦 79 · ⏱️ 17.05.2018):
	```
	pip install dvc
	```
...
- [GitHub](https://github.com/wandb/wandb) (👨‍💻 150 · 🔀 490 · 📦 24K · 📋 2.5K - 24% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/wandb/client
	```
- [PyPi](https://pypi.org/project/wandb) (📥 2.4M / month · 📦 420 · ⏱️ 01.02.2021):
	```
	pip install wandb
	```
...
- [GitHub](https://github.com/aws/sagemaker-python-sdk) (👨‍💻 370 · 🔀 980 · 📦 2.7K · 📋 1.3K - 36% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/aws/sagemaker-python-sdk
	```
- [PyPi](https://pypi.org/project/sagemaker) (📥 25M / month · 📦 71 · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/pycaret/pycaret) (👨‍💻 120 · 🔀 1.6K · 📥 640 · 📦 3.8K · 📋 2.1K - 13% open · ⏱️ 07.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/pycaret) (📥 220K / month · 📦 14 · ⏱️ 06.06.2022):
	```
	pip install pycaret
	```
...
<details><summary><b><a href="https://github.com/Azure/MachineLearningNotebooks">AzureML SDK</a></b> (🥈35 ·  ⭐ 3.7K) - Python notebooks with ML and deep learning examples with Azure.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Azure/MachineLearningNotebooks) (👨‍💻 64 · 🔀 2.3K · 📥 500 · 📋 1.4K - 24% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/Azure/MachineLearningNotebooks
	```
- [PyPi](https://pypi.org/project/azureml-sdk) (📥 480K / month · 📦 47 · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/aimhubio/aim) (👨‍💻 62 · 🔀 230 · 📦 230 · 📋 890 - 28% open · ⏱️ 08.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/aim) (📥 110K / month · 📦 7 · ⏱️ 07.07.2022):
	```
	pip install aim
	```
...
- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 290 · 🔀 450 · 📦 1.6K · 📋 1.3K - 58% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/snakemake/snakemake
	```
- [PyPi](https://pypi.org/project/snakemake) (📥 59K / month · 📦 240 · ⏱️ 30.06.2022):
	```
...
- [GitHub](https://github.com/lanpa/tensorboardX) (👨‍💻 79 · 🔀 870 · 📥 380 · 📦 31K · 📋 450 - 17% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/lanpa/tensorboardX
	```
- [PyPi](https://pypi.org/project/tensorboardX) (📥 1.6M / month · 📦 950 · ⏱️ 05.06.2022):
	```
...
- [GitHub](https://github.com/Netflix/metaflow) (👨‍💻 71 · 🔀 640 · 📦 480 · 📋 570 - 47% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/Netflix/metaflow
	```
- [PyPi](https://pypi.org/project/metaflow) (📥 120K / month · 📦 17 · ⏱️ 26.01.2023):
	```
...
- [GitHub](https://github.com/PaddlePaddle/VisualDL) (👨‍💻 32 · 🔀 630 · 📥 310 · 📦 2.1K · 📋 500 - 28% open · ⏱️ 04.05.2023):

	```
	git clone https://github.com/PaddlePaddle/VisualDL
	```
- [PyPi](https://pypi.org/project/visualdl) (📥 130K / month · 📦 40 · ⏱️ 17.01.2023):
	```
	pip install visualdl
	```
</details>
<details><summary><b><a href="https://github.com/Kaggle/kaggle-api">kaggle</a></b> (🥈30 ·  ⭐ 5.4K) - Official Kaggle API. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Kaggle/kaggle-api) (👨‍💻 37 · 🔀 1K · 📋 390 - 59% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/Kaggle/kaggle-api
	```
- [PyPi](https://pypi.org/project/kaggle) (📥 160K / month · 📦 370 · ⏱️ 13.03.2021):
	```
	pip install kaggle
	```
...
- [GitHub](https://github.com/IDSIA/sacred) (👨‍💻 100 · 🔀 370 · 📦 2.4K · 📋 550 - 17% open · ⏱️ 02.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/sacred) (📥 37K / month · 📦 110 · ⏱️ 25.01.2023):
	```
	pip install sacred
	```
...
<details><summary><b><a href="https://github.com/neptune-ai/neptune-client">Neptune.ai</a></b> (🥈29 ·  ⭐ 390) - Experiment tracking tool and model registry. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/neptune-ai/neptune-client) (👨‍💻 41 · 🔀 42 · 📋 210 - 16% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/neptune-ai/neptune-client
	```
- [PyPi](https://pypi.org/project/neptune-client) (📥 540K / month · 📦 39 · ⏱️ 01.07.2022):
	```
...
- [GitHub](https://github.com/google/ml-metadata) (👨‍💻 17 · 🔀 120 · 📥 2K · 📦 330 · 📋 100 - 28% open · ⏱️ 07.06.2023):
...
<details><summary><b><a href="https://github.com/guildai/guildai">Guild AI</a></b> (🥉27 ·  ⭐ 800) - Experiment tracking, ML developer tools. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/pytorch/tnt) (👨‍💻 87 · 🔀 230 · 📋 68 - 10% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/pytorch/tnt
	```
- [PyPi](https://pypi.org/project/torchnet) (📥 7.1K / month · 📦 38 · ⏱️ 29.07.2018):
	```
...
- [GitHub](https://github.com/studioml/studio) (👨‍💻 22 · 🔀 52 · 📦 5 · 📋 250 - 22% open · ⏱️ 09.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/studioml) (📥 460 / month · ⏱️ 14.09.2021):
	```
...
- <b><a href="https://github.com/microsoft/tensorwatch">TensorWatch</a></b> (🥉22 ·  ⭐ 3.3K · 💀) - Debugging, monitoring and visualization for Python Machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/TeamHG-Memex/tensorboard_logger">TensorBoard Logger</a></b> (🥉19 ·  ⭐ 620 · 💀) - Log TensorBoard events without touching TensorFlow. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/onnx/onnx) (👨‍💻 280 · 🔀 3.5K · 📥 19K · 📦 16K · 📋 2.4K - 15% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/onnx/onnx
	```
- [PyPi](https://pypi.org/project/onnx) (📥 3M / month · 📦 490 · ⏱️ 18.06.2022):
	```
	pip install onnx
	```
...
<details><summary><b><a href="https://github.com/openai/triton">triton</a></b> (🥇36 ·  ⭐ 7.1K) - Development repository for the Triton language and compiler. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/openai/triton) (👨‍💻 120 · 🔀 700 · 📦 3.4K · 📋 630 - 36% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/openai/triton
	```
- [PyPi](https://pypi.org/project/triton) (📥 3.8M / month · 📦 17 · ⏱️ 04.07.2022):
	```
	pip install triton
	```
</details>
...
<details><summary><b><a href="https://github.com/apple/coremltools">Core ML Tools</a></b> (🥈33 ·  ⭐ 3.4K) - Core ML tools contain supporting tools for Core ML model.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/apple/coremltools) (👨‍💻 150 · 🔀 520 · 📥 6.6K · 📦 3.1K · 📋 1.2K - 19% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/apple/coremltools
	```
- [PyPi](https://pypi.org/project/coremltools) (📥 170K / month · 📦 150 · ⏱️ 15.11.2022):
	```
...
- [GitHub](https://github.com/pytorch/serve) (👨‍💻 160 · 🔀 740 · 📥 3.9K · 📋 1.3K - 21% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/pytorch/serve
	```
- [PyPi](https://pypi.org/project/torchserve) (📥 35K / month · 📦 10 · ⏱️ 13.05.2022):
	```
...
- [GitHub](https://github.com/microsoft/hummingbird) (👨‍💻 39 · 🔀 260 · 📥 260 · 📦 79 · 📋 290 - 19% open · ⏱️ 15.05.2023):

	```
	git clone https://github.com/microsoft/hummingbird
	```
- [PyPi](https://pypi.org/project/hummingbird-ml) (📥 6.1K / month · 📦 4 · ⏱️ 10.06.2020):
	```
...
<details><summary><b><a href="https://github.com/nebuly-ai/nebuly">nebullvm</a></b> (🥈26 ·  ⭐ 8.2K) - The next-generation platform to monitor and optimize your AI costs.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/nebuly-ai/nebuly) (👨‍💻 39 · 🔀 640 · 📋 190 - 46% open · ⏱️ 05.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/nebullvm) (📥 490 / month · 📦 1 · ⏱️ 23.01.2023):
	```
...
- [GitHub](https://github.com/microsoft/MMdnn) (👨‍💻 86 · 🔀 980 · 📥 3.7K · 📦 110 · 📋 620 - 53% open · ⏱️ 22.09.2022):

	```
	git clone https://github.com/Microsoft/MMdnn
	```
- [PyPi](https://pypi.org/project/mmdnn) (📥 560 / month · 📦 3 · ⏱️ 24.07.2020):
	```
	pip install mmdnn
	```
</details>
<details><summary><b><a href="https://github.com/fastmachinelearning/hls4ml">hls4ml</a></b> (🥉25 ·  ⭐ 850) - Machine learning on FPGAs using HLS. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/fastmachinelearning/hls4ml) (👨‍💻 53 · 🔀 320 · 📋 360 - 35% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/fastmachinelearning/hls4ml
	```
- [PyPi](https://pypi.org/project/hls4ml) (📥 680 / month · ⏱️ 12.11.2021):
	```
	pip install hls4ml
	```
- [Conda](https://anaconda.org/conda-forge/hls4ml) (📥 6K · ⏱️ 12.11.2021):
	```
...
- [GitHub](https://github.com/cortexlabs/cortex) (👨‍💻 24 · 🔀 610 · 📋 1.1K - 10% open · ⏱️ 04.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/cortex) (📥 1.2K / month · 📦 1 · ⏱️ 23.09.2022):
	```
	pip install cortex
	```
</details>
...
- [GitHub](https://github.com/BayesWitnesses/m2cgen) (👨‍💻 14 · 🔀 210 · 📥 47 · 📦 130 · 📋 100 - 30% open · ⏱️ 05.10.2022):
...
- <b><a href="https://github.com/apple/ml-ane-transformers">ml-ane-transformers</a></b> (🥉14 ·  ⭐ 2.3K · 💤) - Reference implementation of the Transformer.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/arviz-devs/arviz) (👨‍💻 140 · 🔀 330 · 📥 130 · 📦 4.2K · 📋 820 - 20% open · ⏱️ 12.05.2023):

	```
	git clone https://github.com/arviz-devs/arviz
	```
- [PyPi](https://pypi.org/project/arviz) (📥 1.3M / month · 📦 130 · ⏱️ 13.05.2022):
	```
	pip install arviz
	```
...
- [GitHub](https://github.com/lutzroeder/netron) (👨‍💻 2 · 🔀 2.5K · 📥 67K · 📦 10 · 📋 940 - 2% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/lutzroeder/netron
	```
- [PyPi](https://pypi.org/project/netron) (📥 13K / month · 📦 69 · ⏱️ 28.01.2023):
	```
	pip install netron
	```
</details>
...
- [GitHub](https://github.com/huggingface/evaluate) (👨‍💻 120 · 🔀 150 · 📦 2.3K · 📋 210 - 45% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/huggingface/evaluate
	```
- [PyPi](https://pypi.org/project/evaluate) (📥 520K / month · 📦 86 · ⏱️ 16.06.2022):
	```
...
- [GitHub](https://github.com/parrt/dtreeviz) (👨‍💻 24 · 🔀 310 · 📦 800 · 📋 180 - 29% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/parrt/dtreeviz
	```
- [PyPi](https://pypi.org/project/dtreeviz) (📥 96K / month · 📦 24 · ⏱️ 07.07.2022):
	```
...
- [GitHub](https://github.com/MAIF/shapash) (👨‍💻 35 · 🔀 270 · 📦 110 · 📋 160 - 16% open · ⏱️ 09.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/shapash) (📥 6.8K / month · 📦 2 · ⏱️ 09.05.2022):
	```
	pip install shapash
	```
</details>
...
- [GitHub](https://github.com/oegedijk/explainerdashboard) (👨‍💻 19 · 🔀 240 · 📦 310 · 📋 210 - 8% open · ⏱️ 09.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/explainerdashboard) (📥 38K / month · 📦 8 · ⏱️ 02.01.2023):
	```
...
- [GitHub](https://github.com/quantumblacklabs/causalnex) (👨‍💻 34 · 🔀 220 · 📦 94 · 📋 130 - 15% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/quantumblacklabs/causalnex
	```
- [PyPi](https://pypi.org/project/causalnex) (📥 4.2K / month · 📦 2 · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/fairlearn/fairlearn) (👨‍💻 75 · 🔀 350 · 📋 430 - 38% open · ⏱️ 04.05.2023):

	```
	git clone https://github.com/fairlearn/fairlearn
	```
- [PyPi](https://pypi.org/project/fairlearn) (📥 110K / month · 📦 22 · ⏱️ 07.07.2021):
	```
...
- [GitHub](https://github.com/Trusted-AI/AIF360) (👨‍💻 63 · 🔀 690 · 📦 260 · 📋 260 - 66% open · ⏱️ 04.11.2022):

	```
	git clone https://github.com/Trusted-AI/AIF360
	```
- [PyPi](https://pypi.org/project/aif360) (📥 5.6K / month · 📦 12 · ⏱️ 04.03.2021):
	```
	pip install aif360
	```
...
- [GitHub](https://github.com/Trusted-AI/AIX360) (👨‍💻 40 · 🔀 290 · 📦 73 · 📋 83 - 65% open · ⏱️ 24.05.2023):

	```
	git clone https://github.com/Trusted-AI/AIX360
	```
- [PyPi](https://pypi.org/project/aix360) (📥 590 / month · 📦 1 · ⏱️ 28.10.2020):
	```
	pip install aix360
	```
</details>
...
- [GitHub](https://github.com/marcotcr/checklist) (👨‍💻 13 · 🔀 190 · 📦 250 · 📋 110 - 22% open · ⏱️ 12.08.2022):

	```
	git clone https://github.com/marcotcr/checklist
	```
- [PyPi](https://pypi.org/project/checklist) (📥 4.6K / month · 📦 7 · ⏱️ 24.05.2021):
	```
...
<details><summary><b><a href="https://github.com/DistrictDataLabs/yellowbrick">yellowbrick</a></b> (🥉23 ·  ⭐ 4K) - Visual analysis and diagnostic tools to facilitate machine.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/interpretml/DiCE">DiCE</a></b> (🥉22 ·  ⭐ 1.1K) - Generate Diverse Counterfactual Explanations for any machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/interpretml/DiCE) (👨‍💻 16 · 🔀 160 · 📋 150 - 42% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/interpretml/DiCE
	```
- [PyPi](https://pypi.org/project/dice-ml) (📥 30K / month · 📦 5 · ⏱️ 02.06.2022):
	```
	pip install dice-ml
	```
</details>
...
- [GitHub](https://github.com/dssg/aequitas) (👨‍💻 18 · 🔀 95 · 📦 140 · 📋 70 - 68% open · ⏱️ 12.05.2023):

	```
	git clone https://github.com/dssg/aequitas
	```
- [PyPi](https://pypi.org/project/aequitas) (📥 1.6K / month · 📦 6 · ⏱️ 16.12.2020):
	```
...
- [GitHub](https://github.com/tensorflow/model-card-toolkit) (👨‍💻 21 · 🔀 79 · 📥 4 · 📦 19 · 📋 26 - 34% open · ⏱️ 21.05.2023):

	```
	git clone https://github.com/tensorflow/model-card-toolkit
	```
- [PyPi](https://pypi.org/project/model-card-toolkit) (📥 940 / month · 📦 1 · ⏱️ 28.04.2022):
	```
...
<details><summary><b><a href="https://github.com/aerdem4/lofo-importance">LOFO</a></b> (🥉18 ·  ⭐ 740) - Leave One Feature Out Importance. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/aerdem4/lofo-importance) (👨‍💻 5 · 🔀 74 · 📦 26 · 📋 26 - 23% open · ⏱️ 14.04.2023):

	```
	git clone https://github.com/aerdem4/lofo-importance
	```
- [PyPi](https://pypi.org/project/lofo-importance) (📥 1.7K / month · 📦 2 · ⏱️ 27.04.2022):
	```
	pip install lofo-importance
	```
</details>
<details><summary><b><a href="https://github.com/marcotcr/anchor">Anchor</a></b> (🥉16 ·  ⭐ 760 · 💤) - Code for High-Precision Model-Agnostic Explanations paper. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/marcotcr/anchor) (👨‍💻 10 · 🔀 110 · 📋 75 - 32% open · ⏱️ 19.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/anchor_exp) (📥 1.1K / month · 📦 2 · ⏱️ 10.09.2020):
	```
...
- [GitHub](https://github.com/explainX/explainx) (👨‍💻 4 · 🔀 48 · 📥 11 · 📋 29 - 41% open · ⏱️ 15.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/explainx) (📥 2.7K / month · ⏱️ 04.02.2021):
	```
...
- <b><a href="https://github.com/understandable-machine-intelligence-lab/Quantus">Quantus</a></b> (🥉22 ·  ⭐ 370) - Quantus is an eXplainable AI toolkit for responsible evaluation of.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code>
...
- <b><a href="https://github.com/EthicalML/xai">XAI</a></b> (🥉17 ·  ⭐ 920 · 💀) - XAI - An eXplainability toolbox for machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
<details><summary><b><a href="https://github.com/milvus-io/milvus">Milvus</a></b> (🥇39 ·  ⭐ 20K) - A cloud-native vector database, storage for next generation AI.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/milvus-io/milvus) (👨‍💻 250 · 🔀 2.2K · 📥 24K · 📋 8K - 7% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/milvus-io/milvus
	```
- [PyPi](https://pypi.org/project/pymilvus) (📥 470K / month · 📦 24 · ⏱️ 02.04.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/faiss) (👨‍💻 130 · 🔀 3K · 📦 1.1K · 📋 2.1K - 14% open · ⏱️ 07.06.2023):
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 87 · 🔀 1.1K · 📦 2.9K · 📋 390 - 13% open · ⏱️ 08.06.2023):
...
- [GitHub](https://github.com/nmslib/hnswlib) (👨‍💻 65 · 🔀 450 · 📦 1.3K · 📋 300 - 54% open · ⏱️ 05.02.2023):

	```
	git clone https://github.com/nmslib/hnswlib
	```
- [PyPi](https://pypi.org/project/hnswlib) (📥 870K / month · 📦 43 · ⏱️ 14.02.2022):
	```
	pip install hnswlib
	```
...
- [GitHub](https://github.com/lmcinnes/pynndescent) (👨‍💻 24 · 🔀 94 · 📦 3.7K · 📋 120 - 50% open · ⏱️ 20.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/pynndescent) (📥 830K / month · 📦 49 · ⏱️ 31.10.2022):
	```
...
<details><summary><b><a href="https://github.com/yahoojapan/NGT">NGT</a></b> (🥉22 ·  ⭐ 1K) - Nearest Neighbor Search with Neighborhood Graph and Tree for High-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/yahoojapan/NGT) (👨‍💻 14 · 🔀 100 · 📋 120 - 12% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/yahoojapan/NGT
	```
- [PyPi](https://pypi.org/project/ngt) (📥 12K / month · 📦 8 · ⏱️ 21.09.2022):
	```
	pip install ngt
	```
</details>
...
- [GitHub](https://github.com/pixelogik/NearPy) (👨‍💻 19 · 🔀 140 · 📦 81 · 📋 63 - 38% open · ⏱️ 22.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/NearPy) (📥 1.1K / month · 📦 16 · ⏱️ 27.09.2016):
	```
	pip install NearPy
	```
</details>
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 460 · 🔀 1.8K · 📥 1.9K · 📦 1.6K · 📋 3.1K - 6% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/pymc-devs/pymc
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 430K / month · 📦 240 · ⏱️ 15.03.2022):
	```
	pip install pymc3
	```
...
- [GitHub](https://github.com/tensorflow/probability) (👨‍💻 480 · 🔀 1.1K · 📋 1.4K - 46% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/tensorflow/probability
	```
- [PyPi](https://pypi.org/project/tensorflow-probability) (📥 1.1M / month · 📦 380 · ⏱️ 07.06.2022):
	```
...
- [GitHub](https://github.com/pyro-ppl/pyro) (👨‍💻 140 · 🔀 960 · 📦 1.4K · 📋 1K - 22% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/pyro-ppl/pyro
	```
- [PyPi](https://pypi.org/project/pyro-ppl) (📥 370K / month · 📦 83 · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/cornellius-gp/gpytorch) (👨‍💻 120 · 🔀 500 · 📦 1.3K · 📋 1.3K - 25% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/cornellius-gp/gpytorch
	```
- [PyPi](https://pypi.org/project/gpytorch) (📥 210K / month · 📦 66 · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/pgmpy/pgmpy) (👨‍💻 120 · 🔀 670 · 📥 240 · 📦 650 · 📋 850 - 29% open · ⏱️ 17.05.2023):

	```
	git clone https://github.com/pgmpy/pgmpy
	```
- [PyPi](https://pypi.org/project/pgmpy) (📥 61K / month · 📦 22 · ⏱️ 30.06.2022):
	```
	pip install pgmpy
	```
</details>
...
- [GitHub](https://github.com/jmschrei/pomegranate) (👨‍💻 68 · 🔀 570 · 📦 940 · 📋 720 - 1% open · ⏱️ 22.05.2023):

	```
	git clone https://github.com/jmschrei/pomegranate
	```
- [PyPi](https://pypi.org/project/pomegranate) (📥 35K / month · 📦 55 · ⏱️ 19.11.2021):
	```
...
- [GitHub](https://github.com/hmmlearn/hmmlearn) (👨‍💻 44 · 🔀 730 · 📦 1.9K · 📋 420 - 13% open · ⏱️ 18.04.2023):

	```
	git clone https://github.com/hmmlearn/hmmlearn
	```
- [PyPi](https://pypi.org/project/hmmlearn) (📥 240K / month · 📦 140 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/GPflow/GPflow) (👨‍💻 83 · 🔀 440 · 📦 520 · 📋 820 - 17% open · ⏱️ 03.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/gpflow) (📥 52K / month · 📦 30 · ⏱️ 13.08.2019):
	```
	pip install gpflow
	```
...
- [GitHub](https://github.com/dfm/emcee) (👨‍💻 68 · 🔀 430 · 📦 1.9K · 📋 280 - 17% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/dfm/emcee
	```
- [PyPi](https://pypi.org/project/emcee) (📥 120K / month · 📦 340 · ⏱️ 10.05.2022):
	```
	pip install emcee
	```
...
- [GitHub](https://github.com/SALib/SALib) (👨‍💻 41 · 🔀 220 · 📦 780 · 📋 300 - 14% open · ⏱️ 02.05.2023):

	```
	git clone https://github.com/SALib/SALib
	```
- [PyPi](https://pypi.org/project/salib) (📥 130K / month · 📦 74 · ⏱️ 22.06.2022):
	```
	pip install salib
	```
...
- [GitHub](https://github.com/twopirllc/pandas-ta) (👨‍💻 45 · 🔀 760 · 📦 3.1K · 📋 510 - 21% open · ⏱️ 24.09.2022):

	```
	git clone https://github.com/twopirllc/pandas-ta
	```
- [PyPi](https://pypi.org/project/pandas-ta) (📥 66K / month · 📦 33 · ⏱️ 28.07.2021):
	```
...
- [GitHub](https://github.com/rlabbe/filterpy) (👨‍💻 43 · 🔀 550 · 📦 3.3K · 📋 220 - 26% open · ⏱️ 22.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/filterpy) (📥 2.3M / month · 📦 150 · ⏱️ 10.10.2018):
	```
...
<details><summary><b><a href="https://github.com/pydata/patsy">patsy</a></b> (🥉30 ·  ⭐ 890 · 💤) - Describing statistical models in Python using symbolic formulas. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pydata/patsy) (👨‍💻 17 · 🔀 100 · 📦 73K · 📋 150 - 50% open · ⏱️ 09.10.2022):

	```
	git clone https://github.com/pydata/patsy
	```
- [PyPi](https://pypi.org/project/patsy) (📥 9.2M / month · 📦 2.7K · ⏱️ 26.09.2021):
	```
	pip install patsy
	```
- [Conda](https://anaconda.org/conda-forge/patsy) (📥 8.1M · ⏱️ 09.10.2022):
	```
...
- [GitHub](https://github.com/bambinos/bambi) (👨‍💻 32 · 🔀 100 · 📦 72 · 📋 340 - 21% open · ⏱️ 08.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/bambi) (📥 15K / month · 📦 4 · ⏱️ 06.06.2022):
	```
	pip install bambi
	```
...
- [GitHub](https://github.com/baal-org/baal) (👨‍💻 19 · 🔀 76 · 📦 49 · 📋 99 - 23% open · ⏱️ 19.05.2023):
...
- [GitHub](https://github.com/Trusted-AI/adversarial-robustness-toolbox) (👨‍💻 130 · 🔀 1K · 📦 370 · 📋 820 - 15% open · ⏱️ 29.05.2023):

	```
	git clone https://github.com/Trusted-AI/adversarial-robustness-toolbox
	```
- [PyPi](https://pypi.org/project/adversarial-robustness-toolbox) (📥 18K / month · 📦 8 · ⏱️ 21.04.2023):
	```
...
- [GitHub](https://github.com/cleverhans-lab/cleverhans) (👨‍💻 130 · 🔀 1.4K · 📦 470 · 📋 460 - 8% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/cleverhans-lab/cleverhans
	```
- [PyPi](https://pypi.org/project/cleverhans) (📥 1.1K / month · 📦 12 · ⏱️ 24.07.2021):
	```
...
- [GitHub](https://github.com/QData/TextAttack) (👨‍💻 58 · 🔀 320 · 📦 180 · 📋 260 - 17% open · ⏱️ 21.12.2022):

	```
	git clone https://github.com/QData/TextAttack
	```
- [PyPi](https://pypi.org/project/textattack) (📥 4.7K / month · 📦 6 · ⏱️ 25.05.2022):
	```
...
- [GitHub](https://github.com/advboxes/AdvBox) (👨‍💻 19 · 🔀 250 · 📋 39 - 20% open · ⏱️ 08.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/advbox) (📥 40 / month · ⏱️ 05.12.2018):
	```
	pip install advbox
	```
</details>
...
<details><summary><b><a href="https://github.com/rapidsai/cudf">cuDF</a></b> (🥇31 ·  ⭐ 5.6K) - cuDF - GPU DataFrame Library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/rapidsai/cudf) (👨‍💻 260 · 🔀 690 · 📋 5.5K - 15% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/rapidsai/cudf
	```
- [PyPi](https://pypi.org/project/cudf) (📥 2.1K / month · 📦 5 · ⏱️ 01.06.2020):
	```
	pip install cudf
	```
</details>
...
- [GitHub](https://github.com/huggingface/optimum) (👨‍💻 63 · 🔀 190 · 📦 180 · 📋 330 - 36% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/huggingface/optimum
	```
- [PyPi](https://pypi.org/project/optimum) (📥 110K / month):
	```
	pip install optimum
	```
- [Conda](https://anaconda.org/conda-forge/optimum) (📥 7.5K · ⏱️ 12.07.2022):
	```
...
- [GitHub](https://github.com/NVIDIA/apex) (👨‍💻 120 · 🔀 1.2K · 📦 1.8K · 📋 1.2K - 56% open · ⏱️ 02.06.2023):
...
<details><summary><b><a href="https://github.com/arrayfire/arrayfire">ArrayFire</a></b> (🥈30 ·  ⭐ 4.2K) - ArrayFire: a general purpose GPU library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/arrayfire/arrayfire) (👨‍💻 88 · 🔀 500 · 📥 4K · 📋 1.6K - 17% open · ⏱️ 07.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/arrayfire) (📥 1.2K / month · 📦 6 · ⏱️ 22.02.2022):
	```
	pip install arrayfire
	```
</details>
<details><summary><b><a href="https://github.com/rapidsai/cuml">cuML</a></b> (🥈30 ·  ⭐ 3.4K) - cuML - RAPIDS Machine Learning Library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/rapidsai/cuml) (👨‍💻 160 · 🔀 460 · 📦 1 · 📋 2.3K - 32% open · ⏱️ 07.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/cuml) (📥 2K / month · 📦 4 · ⏱️ 01.06.2020):
	```
	pip install cuml
	```
</details>
...
- [GitHub](https://github.com/wookayin/gpustat) (👨‍💻 17 · 🔀 250 · 📦 3.5K · 📋 110 - 20% open · ⏱️ 01.06.2023):
...
<details><summary><b><a href="https://github.com/inducer/pycuda">PyCUDA</a></b> (🥈29 ·  ⭐ 1.6K) - CUDA integration for Python, plus shiny features. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/inducer/pycuda) (👨‍💻 80 · 🔀 270 · 📦 2.2K · 📋 250 - 31% open · ⏱️ 27.05.2023):

	```
	git clone https://github.com/inducer/pycuda
	```
- [PyPi](https://pypi.org/project/pycuda) (📥 40K / month · 📦 210 · ⏱️ 21.12.2022):
	```
	pip install pycuda
	```
- [Conda](https://anaconda.org/conda-forge/pycuda) (📥 220K · ⏱️ 21.12.2022):
	```
	conda install -c conda-forge pycuda
	```
</details>
<details><summary><b><a href="https://github.com/rapidsai/cugraph">cuGraph</a></b> (🥈27 ·  ⭐ 1.3K) - cuGraph - RAPIDS Graph Analytics Library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/rapidsai/cugraph) (👨‍💻 100 · 🔀 240 · 📦 2 · 📋 1.5K - 20% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/rapidsai/cugraph
	```
- [PyPi](https://pypi.org/project/cugraph) (📥 200 / month · 📦 1 · ⏱️ 01.06.2020):
	```
	pip install cugraph
	```
...
<details><summary><b><a href="https://github.com/cupy/cupy">CuPy</a></b> (🥉25 ·  ⭐ 7K) - NumPy & SciPy for GPU. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/cupy/cupy) (👨‍💻 260 · 🔀 690):

	```
	git clone https://github.com/cupy/cupy
	```
- [PyPi](https://pypi.org/project/cupy) (📥 25K / month · 📦 170 · ⏱️ 19.01.2023):
	```
	pip install cupy
	```
...
- [GitHub](https://github.com/NVIDIA/DALI) (👨‍💻 82 · 🔀 570 · 📋 1.5K - 17% open · ⏱️ 07.06.2023):
...
- [GitHub](https://github.com/NVIDIA-Merlin/Merlin) (👨‍💻 29 · 🔀 79 · 📋 410 - 43% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/NVIDIA-Merlin/Merlin
	```
- [PyPi](https://pypi.org/project/merlin-core) (📥 12K / month):
	```
...
- [GitHub](https://github.com/KomputeProject/kompute) (👨‍💻 22 · 🔀 79 · 📥 350 · 📦 7 · 📋 190 - 34% open · ⏱️ 28.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/kp) (📥 110 / month · ⏱️ 13.04.2022):
	```
	pip install kp
	```
</details>
...
- <b><a href="https://github.com/nicolargo/nvidia-ml-py3">nvidia-ml-py3</a></b> (🥉18 ·  ⭐ 110 · 💀) - Python 3 Bindings for the NVIDIA Management Library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
<details><summary><b><a href="https://github.com/tensorflow/datasets">TensorFlow Datasets</a></b> (🥇35 ·  ⭐ 3.9K) - TFDS is a collection of datasets ready to use with.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/datasets) (👨‍💻 280 · 🔀 1.4K · 📋 1.3K - 49% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/tensorflow/datasets
	```
- [PyPi](https://pypi.org/project/tensorflow-datasets) (📥 1.4M / month · 📦 180 · ⏱️ 02.06.2022):
	```
...
- [GitHub](https://github.com/tensorflow/addons) (👨‍💻 200 · 🔀 590 · 📦 12K · 📋 1.1K - 21% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/tensorflow/addons
	```
- [PyPi](https://pypi.org/project/tensorflow-addons) (📥 1.2M / month · 📦 200 · ⏱️ 14.06.2022):
	```
...
- [GitHub](https://github.com/tensorflow/hub) (👨‍💻 100 · 🔀 1.7K · 📋 670 - 0% open · ⏱️ 24.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-hub) (📥 1.8M / month · 📦 320 · ⏱️ 14.04.2021):
	```
...
- [GitHub](https://github.com/tensorflow/tensor2tensor) (👨‍💻 240 · 🔀 3.3K · 📦 1.4K · 📋 1.3K - 46% open · ⏱️ 01.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensor2tensor) (📥 8.8K / month · 📦 90 · ⏱️ 21.06.2017):
	```
...
- [GitHub](https://github.com/tensorflow/tfx) (👨‍💻 170 · 🔀 670 · 📋 900 - 13% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/tensorflow/tfx
	```
- [PyPi](https://pypi.org/project/tfx) (📥 140K / month · 📦 14 · ⏱️ 26.05.2022):
	```
	pip install tfx
	```
</details>
...
- [GitHub](https://github.com/tensorflow/model-optimization) (👨‍💻 79 · 🔀 310 · 📦 2.9K · 📋 360 - 55% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/tensorflow/model-optimization
	```
- [PyPi](https://pypi.org/project/tensorflow-model-optimization) (📥 330K / month · 📦 30 · ⏱️ 18.03.2022):
	```
...
- [GitHub](https://github.com/tensorflow/transform) (👨‍💻 27 · 🔀 200 · 📦 1.4K · 📋 200 - 18% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/tensorflow/transform
	```
- [PyPi](https://pypi.org/project/tensorflow-transform) (📥 780K / month · 📦 56 · ⏱️ 08.12.2022):
	```
	pip install tensorflow-transform
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/io">TensorFlow I/O</a></b> (🥉29 ·  ⭐ 650) - Dataset, streaming, and file system extensions.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/io) (👨‍💻 100 · 🔀 270 · 📋 610 - 42% open · ⏱️ 25.05.2023):

	```
	git clone https://github.com/tensorflow/io
	```
- [PyPi](https://pypi.org/project/tensorflow-io) (📥 1.8M / month · 📦 30 · ⏱️ 18.05.2022):
	```
...
- [GitHub](https://github.com/tensorflow/neural-structured-learning) (👨‍💻 37 · 🔀 190 · 📦 360 · 📋 68 - 1% open · ⏱️ 26.04.2023):

	```
	git clone https://github.com/tensorflow/neural-structured-learning
	```
- [PyPi](https://pypi.org/project/neural-structured-learning) (📥 13K / month · 📦 3 · ⏱️ 29.07.2022):
	```
...
- [GitHub](https://github.com/tensorflow/cloud) (👨‍💻 27 · 🔀 75 · 📦 270 · 📋 87 - 68% open · ⏱️ 22.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-cloud) (📥 70K / month · 📦 7 · ⏱️ 17.06.2021):
	```
...
- [GitHub](https://github.com/tensorflow/compression) (👨‍💻 21 · 🔀 230 · 📋 97 - 6% open · ⏱️ 06.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-compression) (📥 4.7K / month · 📦 2 · ⏱️ 23.11.2022):
	```
...
- <b><a href="https://github.com/PAIR-code/saliency">Saliency</a></b> (🥉22 ·  ⭐ 880 · 💀) - Framework-agnostic implementation for state-of-the-art.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/patrick-kidger/equinox) (👨‍💻 30 · 🔀 72 · 📦 150 · 📋 190 - 25% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/patrick-kidger/equinox
	```
- [PyPi](https://pypi.org/project/equinox) (📥 6.9K / month · 📦 16 · ⏱️ 17.11.2022):
	```
	pip install equinox
	```
</details>
...
- [GitHub](https://github.com/google/evojax) (👨‍💻 13 · 🔀 56 · 📦 6 · 📋 25 - 36% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/google/evojax
	```
- [PyPi](https://pypi.org/project/evojax) (📥 700 / month · 📦 1 · ⏱️ 15.06.2022):
	```
	pip install evojax
	```
...
- [GitHub](https://github.com/rasbt/mlxtend) (👨‍💻 98 · 🔀 820 · 📦 9.4K · 📋 460 - 27% open · ⏱️ 21.05.2023):

	```
	git clone https://github.com/rasbt/mlxtend
	```
- [PyPi](https://pypi.org/project/mlxtend) (📥 770K / month · 📦 160 · ⏱️ 27.05.2022):
	```
	pip install mlxtend
	```
- [Conda](https://anaconda.org/conda-forge/mlxtend) (📥 280K · ⏱️ 06.04.2023):
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/imbalanced-learn) (👨‍💻 71 · 🔀 1.2K · 📦 18K · 📋 560 - 11% open · ⏱️ 28.12.2022):

	```
	git clone https://github.com/scikit-learn-contrib/imbalanced-learn
	```
- [PyPi](https://pypi.org/project/imbalanced-learn) (📥 3M / month · 📦 310 · ⏱️ 16.05.2022):
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/category_encoders) (👨‍💻 61 · 🔀 380 · 📦 5.4K · 📋 270 - 16% open · ⏱️ 19.05.2023):

	```
	git clone https://github.com/scikit-learn-contrib/category_encoders
	```
- [PyPi](https://pypi.org/project/category_encoders) (📥 1.3M / month · 📦 140 · ⏱️ 14.01.2023):
	```
...
<details><summary><b><a href="https://github.com/intel/scikit-learn-intelex">scikit-learn-intelex</a></b> (🥈33 ·  ⭐ 980) - Intel(R) Extension for Scikit-learn is a seamless way.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/intel/scikit-learn-intelex) (👨‍💻 74 · 🔀 160 · 📦 6.5K · 📋 220 - 34% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/intel/scikit-learn-intelex
	```
- [PyPi](https://pypi.org/project/scikit-learn-intelex) (📥 130K / month · 📦 14 · ⏱️ 23.01.2023):
	```
...
- [GitHub](https://github.com/scikit-multilearn/scikit-multilearn) (👨‍💻 28 · 🔀 160 · 📦 1.1K · 📋 210 - 41% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/scikit-multilearn/scikit-multilearn
	```
- [PyPi](https://pypi.org/project/scikit-multilearn) (📥 85K / month · 📦 21 · ⏱️ 10.12.2018):
	```
...
- [GitHub](https://github.com/koaning/scikit-lego) (👨‍💻 57 · 🔀 99 · 📦 94 · 📋 260 - 10% open · ⏱️ 04.03.2023):

	```
	git clone https://github.com/koaning/scikit-lego
	```
- [PyPi](https://pypi.org/project/scikit-lego) (📥 30K / month · 📦 7 · ⏱️ 05.06.2022):
	```
...
- [GitHub](https://github.com/guofei9987/scikit-opt) (👨‍💻 17 · 🔀 870 · 📦 120 · 📋 160 - 33% open · ⏱️ 19.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/scikit-opt) (📥 3.2K / month · 📦 8 · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/trent-b/iterative-stratification) (👨‍💻 7 · 🔀 69 · 📦 320 · 📋 26 - 15% open · ⏱️ 06.06.2022):

	```
	git clone https://github.com/trent-b/iterative-stratification
	```
- [PyPi](https://pypi.org/project/iterative-stratification) (📥 61K / month · 📦 12 · ⏱️ 03.10.2021):
	```
...
- [GitHub](https://github.com/yzhao062/combo) (👨‍💻 2 · 🔀 100 · 📦 550 · 📋 15 - 80% open · ⏱️ 14.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/combo) (📥 42K / month · 📦 5 · ⏱️ 02.04.2022):
	```
	pip install combo
	```
</details>
<details><summary><b><a href="https://github.com/scikit-learn-contrib/DESlib">DESlib</a></b> (🥉19 ·  ⭐ 440) - A Python library for dynamic classifier and ensemble selection. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/scikit-learn-contrib/DESlib) (👨‍💻 15 · 🔀 73 · 📦 40 · 📋 150 - 9% open · ⏱️ 27.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/deslib) (📥 1.2K / month · 📦 2 · ⏱️ 08.02.2021):
	```
	pip install deslib
	```
</details>
...
- [GitHub](https://github.com/huggingface/accelerate) (👨‍💻 140 · 🔀 510 · 📦 7.5K · 📋 770 - 12% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/huggingface/accelerate
	```
- [PyPi](https://pypi.org/project/accelerate) (📥 3.4M / month · 📦 140 · ⏱️ 15.06.2022):
	```
...
- [GitHub](https://github.com/KevinMusgrave/pytorch-metric-learning) (👨‍💻 34 · 🔀 620 · 📦 700 · 📋 460 - 10% open · ⏱️ 27.05.2023):

	```
	git clone https://github.com/KevinMusgrave/pytorch-metric-learning
	```
- [PyPi](https://pypi.org/project/pytorch-metric-learning) (📥 240K / month · 📦 17 · ⏱️ 29.06.2022):
	```
...
- [GitHub](https://github.com/geohot/tinygrad) (👨‍💻 130 · 🔀 1.3K · 📦 19 · 📋 250 - 23% open · ⏱️ 08.06.2023):
...
- [GitHub](https://github.com/Lightning-Universe/lightning-flash) (👨‍💻 86 · 🔀 200 · 📦 230 · 📋 520 - 5% open · ⏱️ 08.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/lightning-flash) (📥 2.3K / month · 📦 5 · ⏱️ 11.05.2022):
	```
...
<details><summary><b><a href="https://github.com/rtqichen/torchdiffeq">torchdiffeq</a></b> (🥈29 ·  ⭐ 4.7K) - Differentiable ODE solvers with full GPU support and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/rtqichen/torchdiffeq) (👨‍💻 21 · 🔀 820 · 📦 1.5K · 📋 200 - 27% open · ⏱️ 20.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/torchdiffeq) (📥 1.5M / month · 📦 36 · ⏱️ 22.04.2022):
	```
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_scatter">torch-scatter</a></b> (🥈27 ·  ⭐ 1.3K) - PyTorch Extension Library of Optimized Scatter Operations. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_scatter) (👨‍💻 27 · 🔀 160 · 📋 320 - 5% open · ⏱️ 04.06.2023):

	```
	git clone https://github.com/rusty1s/pytorch_scatter
	```
- [PyPi](https://pypi.org/project/torch-scatter) (📥 45K / month · 📦 67 · ⏱️ 24.11.2022):
	```
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_sparse">PyTorch Sparse</a></b> (🥈26 ·  ⭐ 830) - PyTorch Extension Library of Optimized Autograd Sparse.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_sparse) (👨‍💻 43 · 🔀 140 · 📋 240 - 11% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/rusty1s/pytorch_sparse
	```
- [PyPi](https://pypi.org/project/torch-sparse) (📥 28K / month · 📦 59 · ⏱️ 22.12.2022):
	```
...
- [GitHub](https://github.com/dreamquark-ai/tabnet) (👨‍💻 19 · 🔀 420 · 📋 290 - 14% open · ⏱️ 25.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-tabnet) (📥 31K / month · 📦 10 · ⏱️ 19.09.2022):
	```
...
- [GitHub](https://github.com/BloodAxe/pytorch-toolbelt) (👨‍💻 7 · 🔀 120 · 📥 28 · 📋 29 - 6% open · ⏱️ 04.05.2023):

	```
	git clone https://github.com/BloodAxe/pytorch-toolbelt
	```
- [PyPi](https://pypi.org/project/pytorch_toolbelt) (📥 18K / month · 📦 7 · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/lucidrains/reformer-pytorch) (👨‍💻 11 · 🔀 250 · 📋 120 - 11% open · ⏱️ 24.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/reformer-pytorch) (📥 2.1K / month · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/abhishekkrthakur/tez) (👨‍💻 2 · 🔀 140 · 📦 43 · 📋 43 - 58% open · ⏱️ 16.09.2022):

	```
	git clone https://github.com/abhishekkrthakur/tez
	```
- [PyPi](https://pypi.org/project/tez) (📥 500 / month · 📦 2 · ⏱️ 20.09.2022):
	```
	pip install tez
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/madgrad) (👨‍💻 2 · 🔀 56 · 📦 55 · 📋 11 - 9% open · ⏱️ 11.04.2023):

	```
	git clone https://github.com/facebookresearch/madgrad
	```
- [PyPi](https://pypi.org/project/madgrad) (📥 3.8K / month · 📦 1 · ⏱️ 08.03.2022):
	```
	pip install madgrad
	```
</details>
...
- <b><a href="https://github.com/sksq96/pytorch-summary">pytorch-summary</a></b> (🥈27 ·  ⭐ 3.8K · 💀) - Model summary in PyTorch similar to `model.summary()`.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/facebookresearch/higher">Higher</a></b> (🥉23 ·  ⭐ 1.5K · 💀) - higher is a pytorch library allowing users to obtain higher.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/karpathy/micrograd">micrograd</a></b> (🥉18 ·  ⭐ 5.2K · 💀) - A tiny scalar-valued autograd engine and a neural net library.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.5K · 🔀 4.7K · 📥 370K · 📦 750K · 📋 9.4K - 17% open · ⏱️ 08.06.2023):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 4K · 📥 500K · 📦 65K · 📋 13K - 36% open · ⏱️ 03.06.2023):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 9.2M / month · 📦 4.5K · ⏱️ 30.08.2022):
	```
	pip install sympy
	```
...
- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 170 · 🔀 1.2K · 📦 7.9K · 📋 2.2K - 15% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/gradio-app/gradio
	```
- [PyPi](https://pypi.org/project/gradio) (📥 3.6M / month · 📦 90 · ⏱️ 20.02.2023):
	```
	pip install gradio
	```
</details>
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 220 · 🔀 1.5K · 📦 210 · 📋 1.6K - 27% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/deepchem/deepchem
	```
- [PyPi](https://pypi.org/project/deepchem) (📥 23K / month · 📦 7 · ⏱️ 06.07.2022):
	```
...
- [GitHub](https://github.com/HIPS/autograd) (👨‍💻 54 · 🔀 860 · 📦 5.5K · 📋 400 - 42% open · ⏱️ 25.05.2023):
...
- [GitHub](https://github.com/simonw/datasette) (👨‍💻 75 · 🔀 530 · 📥 44 · 📦 1K · 📋 1.6K - 31% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/simonw/datasette
	```
- [PyPi](https://pypi.org/project/datasette) (📥 34K / month · 📦 170 · ⏱️ 02.05.2022):
	```
...
- [GitHub](https://github.com/serge-sans-paille/pythran) (👨‍💻 70 · 🔀 190 · 📦 890 · 📋 810 - 15% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/serge-sans-paille/pythran
	```
- [PyPi](https://pypi.org/project/pythran) (📥 280K / month · 📦 22 · ⏱️ 02.01.2020):
	```
	pip install pythran
	```
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 48 · 🔀 1.2K · 📦 2.4K · 📋 300 - 52% open · ⏱️ 20.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyod) (📥 520K / month · 📦 51 · ⏱️ 16.12.2022):
	```
	pip install pyod
	```
...
- [GitHub](https://github.com/online-ml/river) (👨‍💻 97 · 🔀 470 · 📦 310 · 📋 440 - 4% open · ⏱️ 06.06.2023):

	```
	git clone https://github.com/online-ml/river
	```
- [PyPi](https://pypi.org/project/river) (📥 13K / month · 📦 23 · ⏱️ 06.06.2022):
	```
	pip install river
	```
...
- [GitHub](https://github.com/adapter-hub/adapter-transformers) (👨‍💻 1.7K · 🔀 280 · 📦 180 · 📋 320 - 19% open · ⏱️ 22.05.2023):

	```
	git clone https://github.com/Adapter-Hub/adapter-transformers
	```
- [PyPi](https://pypi.org/project/adapter-transformers) (📥 17K / month · 📦 7 · ⏱️ 18.05.2022):
	```
...
- [GitHub](https://github.com/wireservice/agate) (👨‍💻 51 · 🔀 150 · 📦 1.8K · 📋 650 - 2% open · ⏱️ 05.06.2023):

	```
	git clone https://github.com/wireservice/agate
	```
- [PyPi](https://pypi.org/project/agate) (📥 2.7M / month · 📦 140 · ⏱️ 15.07.2021):
	```
	pip install agate
	```
...
- [GitHub](https://github.com/PennyLaneAI/pennylane) (👨‍💻 140 · 🔀 470 · 📥 67 · 📋 1.1K - 29% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/PennyLaneAI/PennyLane
	```
- [PyPi](https://pypi.org/project/pennylane) (📥 27K / month · 📦 53 · ⏱️ 03.05.2021):
	```
...
- [GitHub](https://github.com/tensorly/tensorly) (👨‍💻 62 · 🔀 270 · 📦 420 · 📋 240 - 24% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/tensorly/tensorly
	```
- [PyPi](https://pypi.org/project/tensorly) (📥 15K / month · 📦 43 · ⏱️ 14.01.2023):
	```
...
<details><summary><b><a href="https://github.com/inducer/pyopencl">pyopencl</a></b> (🥈31 ·  ⭐ 980) - OpenCL integration for Python, plus shiny features. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/inducer/pyopencl) (👨‍💻 94 · 🔀 240 · 📦 1.5K · 📋 330 - 21% open · ⏱️ 25.05.2023):

	```
	git clone https://github.com/inducer/pyopencl
	```
- [PyPi](https://pypi.org/project/pyopencl) (📥 53K / month · 📦 200 · ⏱️ 21.11.2022):
	```
	pip install pyopencl
	```
- [Conda](https://anaconda.org/conda-forge/pyopencl) (📥 880K · ⏱️ 09.05.2023):
	```
...
- [GitHub](https://github.com/datalad/datalad) (👨‍💻 55 · 🔀 110 · 📋 3.8K - 12% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/datalad/datalad
	```
- [PyPi](https://pypi.org/project/datalad) (📥 8.6K / month · 📦 57 · ⏱️ 24.08.2022):
	```
	pip install datalad
	```
- [Conda](https://anaconda.org/conda-forge/datalad) (📥 350K · ⏱️ 16.05.2023):
	```
...
- [GitHub](https://github.com/SeldonIO/alibi-detect) (👨‍💻 18 · 🔀 180 · 📦 350 · 📋 340 - 35% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/SeldonIO/alibi-detect
	```
- [PyPi](https://pypi.org/project/alibi-detect) (📥 19K / month · 📦 7 · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/ContinualAI/avalanche) (👨‍💻 69 · 🔀 230 · 📥 4 · 📦 29 · 📋 690 - 14% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/ContinualAI/avalanche
	```
- [PyPi](https://pypi.org/project/avalanche-lib) (📥 2.3K / month · 📦 1 · ⏱️ 14.06.2022):
	```
...
- [GitHub](https://github.com/pyjanitor-devs/pyjanitor) (👨‍💻 110 · 🔀 160 · 📦 390 · 📋 540 - 20% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/pyjanitor-devs/pyjanitor
	```
- [PyPi](https://pypi.org/project/pyjanitor) (📥 28K / month · 📦 18 · ⏱️ 03.05.2022):
	```
...
<details><summary><b><a href="https://github.com/openvinotoolkit/anomalib">anomalib</a></b> (🥈28 ·  ⭐ 2K) - An anomaly detection library comprising state-of-the-art algorithms.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/openvinotoolkit/anomalib) (👨‍💻 44 · 🔀 360 · 📥 490 · 📦 14 · 📋 480 - 16% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/openvinotoolkit/anomalib
	```
- [PyPi](https://pypi.org/project/anomalib) (📥 3.8K / month · ⏱️ 05.07.2022):
	```
...
- [GitHub](https://github.com/sepandhaghighi/pycm) (👨‍💻 17 · 🔀 120 · 📦 220 · 📋 200 - 5% open · ⏱️ 07.06.2023):
...
- [GitHub](https://github.com/nicodv/kmodes) (👨‍💻 22 · 🔀 400 · 📦 2.1K · 📋 150 - 11% open · ⏱️ 20.04.2023):

	```
	git clone https://github.com/nicodv/kmodes
	```
- [PyPi](https://pypi.org/project/kmodes) (📥 220K / month · 📦 30 · ⏱️ 14.04.2022):
	```
	pip install kmodes
	```
...
- [GitHub](https://github.com/uber/causalml) (👨‍💻 49 · 🔀 640 · 📦 160 · 📋 320 - 26% open · ⏱️ 26.03.2023):

	```
	git clone https://github.com/uber/causalml
	```
- [PyPi](https://pypi.org/project/causalml) (📥 36K / month · 📦 1 · ⏱️ 14.03.2022):
	```
...
- [GitHub](https://github.com/mars-project/mars) (👨‍💻 46 · 🔀 310 · 📋 1.2K - 17% open · ⏱️ 02.06.2023):

	```
	git clone https://github.com/mars-project/mars
	```
- [PyPi](https://pypi.org/project/pymars) (📥 65K / month · 📦 1 · ⏱️ 12.06.2022):
	```
	pip install pymars
	```
</details>
...
- [GitHub](https://github.com/ljvmiranda921/pyswarms) (👨‍💻 45 · 🔀 320 · 📦 270 · 📋 220 - 8% open · ⏱️ 06.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyswarms) (📥 8.7K / month · 📦 14 · ⏱️ 03.01.2021):
	```
	pip install pyswarms
	```
</details>
<details><summary><b><a href="https://github.com/MaxHalford/prince">Prince</a></b> (🥉27 ·  ⭐ 1K) - Multivariate exploratory data analysis in Python: PCA, CA, MCA, MFA,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/MaxHalford/prince) (👨‍💻 15 · 🔀 170 · 📦 370 · 📋 120 - 0% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/MaxHalford/prince
	```
- [PyPi](https://pypi.org/project/prince) (📥 53K / month · 📦 9 · ⏱️ 06.10.2020):
	```
	pip install prince
	```
...
- [GitHub](https://github.com/google/trax) (👨‍💻 78 · 🔀 790 · 📦 110 · 📋 230 - 46% open · ⏱️ 29.03.2023):

	```
	git clone https://github.com/google/trax
	```
- [PyPi](https://pypi.org/project/trax) (📥 11K / month · 📦 1 · ⏱️ 26.10.2021):
	```
	pip install trax
	```
</details>
...
- [GitHub](https://github.com/scikit-learn-contrib/metric-learn) (👨‍💻 22 · 🔀 230 · 📦 280 · 📋 170 - 30% open · ⏱️ 21.06.2022):

	```
	git clone https://github.com/scikit-learn-contrib/metric-learn
	```
- [PyPi](https://pypi.org/project/metric-learn) (📥 21K / month · 📦 12 · ⏱️ 14.07.2016):
	```
...
<details><summary><b><a href="https://github.com/gventuri/pandas-ai">pandas-ai</a></b> (🥉25 ·  ⭐ 7K · 🐣) - Pandas AI is a Python library that integrates generative artificial.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gventuri/pandas-ai) (👨‍💻 24 · 🔀 460 · 📦 85 · 📋 140 - 25% open · ⏱️ 08.06.2023):
...
<details><summary><b><a href="https://github.com/facebookresearch/AugLy">AugLy</a></b> (🥉25 ·  ⭐ 4.7K) - A data augmentations library for audio, image, text, and video. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/AugLy) (👨‍💻 29 · 🔀 280 · 📦 63 · 📋 73 - 26% open · ⏱️ 24.05.2023):
...
- [GitHub](https://github.com/trevorstephens/gplearn) (👨‍💻 11 · 🔀 240 · 📦 390 · 📋 210 - 10% open · ⏱️ 04.08.2022):

	```
	git clone https://github.com/trevorstephens/gplearn
	```
- [PyPi](https://pypi.org/project/gplearn) (📥 4.3K / month · 📦 13 · ⏱️ 03.05.2022):
	```
	pip install gplearn
	```
...
<details><summary><b><a href="https://github.com/dstackai/dstack">dstack</a></b> (🥉25 ·  ⭐ 690) - Develop ML faster. Easily and cost-effectively run dev environments,.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/dstackai/dstack) (👨‍💻 12 · 🔀 47 · 📦 11 · 📋 270 - 13% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/dstackai/dstack
	```
- [PyPi](https://pypi.org/project/dstack) (📥 1.3K / month · ⏱️ 29.06.2022):
	```
	pip install dstack
	```
</details>
<details><summary><b><a href="https://github.com/solegalli/feature_engine">Feature Engine</a></b> (🥉24 ·  ⭐ 1.4K) - Feature engineering package with sklearn like functionality. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/solegalli/feature_engine) (👨‍💻 38 · 🔀 260 · ⏱️ 07.12.2022):

	```
	git clone https://github.com/solegalli/feature_engine
	```
- [PyPi](https://pypi.org/project/feature_engine) (📥 150K / month · 📦 68 · ⏱️ 22.11.2022):
	```
	pip install feature_engine
	```
- [Conda](https://anaconda.org/conda-forge/feature_engine) (📥 33K · ⏱️ 28.03.2023):
	```
	conda install -c conda-forge feature_engine
	```
</details>
<details><summary><b><a href="https://github.com/BioPandas/biopandas">BioPandas</a></b> (🥉24 ·  ⭐ 610) - Working with molecular structures in pandas DataFrames. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/BioPandas/biopandas) (👨‍💻 11 · 🔀 110 · 📦 180 · 📋 51 - 39% open · ⏱️ 25.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/biopandas) (📥 13K / month · 📦 18 · ⏱️ 13.05.2022):
	```
...
<details><summary><b><a href="https://github.com/astroML/astroML">AstroML</a></b> (🥉23 ·  ⭐ 910) - Machine learning, statistics, and data mining for astronomy and.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/astroML/astroML) (👨‍💻 30 · 🔀 280 · 📋 160 - 39% open · ⏱️ 12.12.2022):

	```
	git clone https://github.com/astroML/astroML
	```
- [PyPi](https://pypi.org/project/astroML) (📥 1.5K / month · 📦 34 · ⏱️ 01.03.2022):
	```
	pip install astroML
	```
...
- [GitHub](https://github.com/kLabUM/rrcf) (👨‍💻 6 · 🔀 100 · 📦 47 · 📋 46 - 56% open · ⏱️ 22.05.2023):
...
- [GitHub](https://github.com/Project-MONAI/MONAILabel) (👨‍💻 46 · 🔀 150 · 📥 55K · 📋 430 - 14% open · ⏱️ 19.05.2023):

	```
	git clone https://github.com/Project-MONAI/MONAILabel
	```
- [PyPi](https://pypi.org/project/monailabel-weekly) (📥 940 / month · ⏱️ 30.10.2022):
	```
...
- [GitHub](https://github.com/modAL-python/modAL) (👨‍💻 20 · 🔀 300 · 📥 23 · 📦 6 · 📋 140 - 61% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/modAL-python/modAL
	```
- [PyPi](https://pypi.org/project/modAL) (📥 4.9K / month · 📦 10 · ⏱️ 07.01.2021):
	```
	pip install modAL
	```
</details>
...
- [GitHub](https://github.com/clementchadebec/benchmark_VAE) (👨‍💻 12 · 🔀 120 · 📦 7 · 📋 39 - 28% open · ⏱️ 23.05.2023):

	```
	git clone https://github.com/clementchadebec/benchmark_VAE
	```
- [PyPi](https://pypi.org/project/pythae) (📥 710 / month · ⏱️ 07.09.2022):
	```
	pip install pythae
	```
</details>
<details><summary><b><a href="https://github.com/pykale/pykale">pykale</a></b> (🥉20 ·  ⭐ 390) - Knowledge-Aware machine LEarning (KALE): accessible machine learning.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pykale/pykale) (👨‍💻 19 · 🔀 56 · 📦 1 · 📋 100 - 6% open · ⏱️ 19.05.2023):
...
- [GitHub](https://github.com/yzhao062/SUOD) (👨‍💻 2 · 🔀 43 · 📦 480 · 📋 10 - 70% open · ⏱️ 07.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/suod) (📥 29K / month · 📦 2 · ⏱️ 01.10.2021):
	```
	pip install suod
	```
</details>
...
- [GitHub](https://github.com/SforAiDl/KD_Lib) (👨‍💻 6 · 🔀 49 · 📋 67 - 26% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/SforAiDl/KD_Lib
	```
- [PyPi](https://pypi.org/project/KD-Lib) (📥 85 / month · ⏱️ 18.05.2022):
	```
	pip install KD-Lib
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/NeuralCompression) (👨‍💻 6 · 🔀 31 · 📋 77 - 23% open · ⏱️ 11.04.2023):

	```
	git clone https://github.com/facebookresearch/NeuralCompression
	```
- [PyPi](https://pypi.org/project/neuralcompression) (📥 110 / month · ⏱️ 12.01.2022):
	```
...
- <b><a href="https://github.com/dbt-labs/metricflow">metricflow</a></b> (🥉23 ·  ⭐ 900) - MetricFlow allows you to define, build, and maintain metrics.. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/eltonlaw/impyute">impyute</a></b> (🥉21 ·  ⭐ 340 · 💀) - Data imputations library to preprocess datasets with missing data. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/jmschrei/apricot">apricot</a></b> (🥉20 ·  ⭐ 480 · 💀) - apricot implements submodular optimization for the purpose of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/infer-actively/pymdp">pymdp</a></b> (🥉20 ·  ⭐ 260) - A Python implementation of active inference for Markov Decision Processes. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/Palashio/nylon">nylon</a></b> (🥉11 ·  ⭐ 81 · 💀) - An intelligent, flexible grammar of machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
